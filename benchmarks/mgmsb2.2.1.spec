...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.64768716e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03985752e+01   # MW
   ...
   1000035     6.51881352e+02   # ~neutralino(4)
   1000037     6.52866132e+02   # ~chargino(2)
   ...
   1000011     5.37215737e+02   # ~e_L
   1000012     5.31012269e+02   # ~nue_L
   1000013     5.37204294e+02   # ~mu_L
   1000014     5.31000702e+02   # ~numu_L
   1000015     3.50840458e+02   # ~stau_1
   1000016     5.27233957e+02   # ~nu_tau_L
...
Block sbotmix               # sbottom mixing matrix
  1  1     5.09741381e-01   # F_{11}
  1  2     8.60327685e-01   # F_{12}
  2  1     8.60327685e-01   # F_{21}
  2  2    -5.09741381e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.05153017e-01   # F_{11}
  1  2     9.94456054e-01   # F_{12}
  2  1     9.94456054e-01   # F_{21}
  2  2    -1.05153017e-01   # F_{22}
Block gauge Q= 8.76516017e+02  # SM gauge couplings
     1     3.62244538e-01   # g'(Q)MSSM DRbar
     2     6.43150184e-01   # g(Q)MSSM DRbar
...
Block hmix Q= 8.76516017e+02 # Higgs mixing parameters
     1     6.37177139e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 8.76516017e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     3.02419767e+02      # M_2(Q)
     3     8.45276985e+02      # M_3(Q)
    21     2.42369730e+05      # mH1^2(Q)
    22    -3.94889937e+05      # mH2^2(Q)
    31     5.33709029e+02      # meL(Q)
    32     5.33697513e+02      # mmuL(Q)
    33     5.30193465e+02      # mtauL(Q)
    34     3.59426196e+02      # meR(Q)
...
Block au Q= 8.76516017e+02  
  1  1    -7.92290707e+02      # Au(Q)MSSM DRbar
...
Block ad Q= 8.76516017e+02  
  ...
  2  2    -9.48759230e+02      # As(Q)MSSM DRbar
  3  3    -8.87032608e+02      # Ab(Q)MSSM DRbar
Block ae Q= 8.76516017e+02  
  1  1    -1.73127898e+02      # Ae(Q)MSSM DRbar
  2  2    -1.73121879e+02      # Amu(Q)MSSM DRbar
  3  3    -1.71295546e+02      # Atau(Q)MSSM DRbar

...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.58434992e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04035162e+01   # MW
   ...
   1000025    -3.68263010e+02   # ~neutralino(3)
   ...
   2000015     3.19079970e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -7.59173549e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.83917914e-01   # N_{1,1}
  1  2    -4.32799988e-02   # N_{1,2}
  1  3     1.57612145e-01   # N_{1,3}
  1  4    -7.20471479e-02   # N_{1,4}
  2  1     1.21887636e-01   # N_{2,1}
  2  2     8.64324147e-01   # N_{2,2}
  2  3    -3.88777386e-01   # N_{2,3}
  2  4     2.94854738e-01   # N_{2,4}
  3  1    -5.62204366e-02   # N_{3,1}
  3  2     7.93596662e-02   # N_{3,2}
  3  3     6.97354144e-01   # N_{3,3}
  3  4     7.10097531e-01   # N_{3,4}
  4  1    -1.17848228e-01   # N_{4,1}
  4  2     4.94745039e-01   # N_{4,2}
  4  3     5.81126280e-01   # N_{4,3}
  4  4    -6.35319910e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.23299264e-01   # U_{1,1}
  1  2    -5.67607542e-01   # U_{1,2}
  2  1     5.67607542e-01   # U_{2,1}
  2  2     8.23299264e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02288991e-01   # V_{1,1}
  1  2    -4.31131739e-01   # V_{1,2}
  2  1     4.31131739e-01   # V_{2,1}
  2  2     9.02288991e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.75880602e-01   # F_{11}
  1  2     8.79509893e-01   # F_{12}
  2  1     8.79509893e-01   # F_{21}
  2  2    -4.75880602e-01   # F_{22}
...
Block msoft Q= 9.37893365e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     2.86308743e+02      # M_2(Q)
     3     7.85300416e+02      # M_3(Q)
    21     8.47389562e+04      # mH1^2(Q)
...
Block ae Q= 9.37893365e+02  
  ...
  2  2    -2.43959988e+01      # Amu(Q)MSSM DRbar
  3  3    -2.43409013e+01      # Atau(Q)MSSM DRbar

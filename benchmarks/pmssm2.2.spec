...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.47679006e-04
...
# PDG code     mass             particle
   ...
   1000011     2.49214436e+02   # ~e_L
   1000012     2.36598444e+02   # ~nue_L
   1000013     2.49214436e+02   # ~mu_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.66462416e-04   # N_{1,2}
  1  3     1.74776199e-02   # N_{1,3}
  1  4    -2.43309201e-03   # N_{1,4}
  2  1     7.48944193e-03   # N_{2,1}
  2  2     8.64216301e-01   # N_{2,2}
  2  3    -3.61647484e-01   # N_{2,3}
  2  4     3.49692994e-01   # N_{2,4}
  3  1    -1.06324250e-02   # N_{3,1}
  3  2     9.76353739e-03   # N_{3,2}
  3  3     7.06900888e-01   # N_{3,3}
  3  4     7.07165298e-01   # N_{3,4}
  4  1    -1.19323604e-02   # N_{4,1}
  4  2     5.03025570e-01   # N_{4,2}
  4  3     6.07615639e-01   # N_{4,3}
  4  4    -6.14512921e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.80623050e-01   # U_{1,1}
  1  2    -6.25002123e-01   # U_{1,2}
  2  1     6.25002123e-01   # U_{2,1}
  2  2     7.80623050e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     7.92748903e-01   # V_{1,1}
  1  2    -6.09548338e-01   # V_{1,2}
  2  1     6.09548338e-01   # V_{2,1}
  2  2     7.92748903e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.24863370e-01   # F_{11}
  1  2     9.05257486e-01   # F_{12}
  2  1     9.05257486e-01   # F_{21}
  2  2    -4.24863370e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.95960955e-01   # F_{11}
  1  2     9.18267348e-01   # F_{12}
  2  1     9.18267348e-01   # F_{21}
  2  2    -3.95960955e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     4.05987094e-01   # F_{11}
  1  2     9.13878810e-01   # F_{12}
  2  1     9.13878810e-01   # F_{21}
  2  2    -4.05987094e-01   # F_{22}
Block gauge Q= 2.50366727e+03  # SM gauge couplings
     1     3.64749763e-01   # g'(Q)MSSM DRbar
     2     6.36093743e-01   # g(Q)MSSM DRbar
     3     1.01384350e+00   # g3(Q)MSSM DRbar
Block yu Q= 2.50366727e+03  
  3  3     8.33687496e-01   # Yt(Q)MSSM DRbar
Block yd Q= 2.50366727e+03  
  3  3     1.25595566e-01   # Yb(Q)MSSM DRbar
Block ye Q= 2.50366727e+03  
  3  3     9.97731977e-02   # Ytau(Q)MSSM DRbar
...
Block msoft Q= 2.50366727e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21    -3.41719265e+05      # mH1^2(Q)
    22    -6.24386137e+06      # mH2^2(Q)
...
Block au Q= 2.50366727e+03  
  1  1     6.10854973e-06      # Au(Q)MSSM DRbar
  2  2     6.10862214e-06      # Ac(Q)MSSM DRbar
  3  3     1.02278084e-05      # At(Q)MSSM DRbar
Block ad Q= 2.50366727e+03  
  1  1     2.09493568e-06      # Ad(Q)MSSM DRbar
  2  2     2.09501039e-06      # As(Q)MSSM DRbar
  3  3     3.43539781e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50366727e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.21597580e-07      # Amu(Q)MSSM DRbar
  3  3     1.21903850e-07      # Atau(Q)MSSM DRbar

...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.16707862e-04
...
# PDG code     mass             particle
   ...
   1000025    -3.04618851e+02   # ~neutralino(3)
   ...
   1000012     2.43498502e+02   # ~nue_L
   1000013     2.56423248e+02   # ~mu_L
   1000014     2.43497366e+02   # ~numu_L
   1000015     1.22807892e+02   # ~stau_1
   1000016     2.42996154e+02   # ~nu_tau_L
   ...
   2000013     1.29432124e+02   # ~mu_R
   2000015     2.58355079e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -7.96317228e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.75217145e-01   # N_{1,1}
  1  2    -6.35461324e-02   # N_{1,2}
  1  3     1.93870154e-01   # N_{1,3}
  1  4    -8.56024107e-02   # N_{1,4}
  2  1     1.61784224e-01   # N_{2,1}
  2  2     8.50470064e-01   # N_{2,2}
  2  3    -4.05482992e-01   # N_{2,3}
  2  4     2.93445188e-01   # N_{2,4}
  3  1    -6.88318965e-02   # N_{3,1}
  3  2     9.77347654e-02   # N_{3,2}
  3  3     6.92438772e-01   # N_{3,3}
  3  4     7.11504486e-01   # N_{3,4}
  4  1    -1.34311411e-01   # N_{4,1}
  4  2     5.12942954e-01   # N_{4,2}
  4  3     5.64381480e-01   # N_{4,3}
  4  4    -6.32711242e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.99959129e-01   # U_{1,1}
  1  2    -6.00054490e-01   # U_{1,2}
  2  1     6.00054490e-01   # U_{2,1}
  2  2     7.99959129e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.00657259e-01   # V_{1,1}
  1  2    -4.34530208e-01   # V_{1,2}
  2  1     4.34530208e-01   # V_{2,1}
  2  2     9.00657259e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     5.43480837e-01   # F_{11}
  1  2     8.39421575e-01   # F_{12}
  2  1     8.39421575e-01   # F_{21}
  2  2    -5.43480837e-01   # F_{22}
...
Block msoft Q= 7.68693064e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     2.29808728e+02      # M_2(Q)
     3     6.41114056e+02      # M_3(Q)
    21     5.42288404e+04      # mH1^2(Q)
    22    -7.85627107e+04      # mH2^2(Q)
...
Block ae Q= 7.68693064e+02  
  1  1    -1.94808716e+01      # Ae(Q)MSSM DRbar
  2  2    -1.94807272e+01      # Amu(Q)MSSM DRbar
  3  3    -1.94367975e+01      # Atau(Q)MSSM DRbar

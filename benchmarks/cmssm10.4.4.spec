...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.05569705e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.56102766e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03955994e+01   # MW
        25     1.15542905e+02   # h0
        35     1.24696053e+03   # H0
        36     1.24690843e+03   # A0
        37     1.24960839e+03   # H+
   1000021     1.19892499e+03   # ~g
   1000022     2.07781374e+02   # ~neutralino(1)
   1000023     3.93581913e+02   # ~neutralino(2)
   1000024     3.93581505e+02   # ~chargino(1)
   1000025    -6.31593263e+02   # ~neutralino(3)
   1000035     6.46483080e+02   # ~neutralino(4)
   1000037     6.46624292e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.74526741e-02   # N_{1,2}
  1  3     8.42332509e-02   # N_{1,3}
  1  4    -3.54965126e-02   # N_{1,4}
  2  1     3.93254888e-02   # N_{2,1}
  2  2     9.67846034e-01   # N_{2,2}
  2  3    -2.05404204e-01   # N_{2,3}
  2  4     1.39773651e-01   # N_{2,4}
  3  1    -3.34166794e-02   # N_{3,1}
  3  2     4.83710543e-02   # N_{3,2}
  3  3     7.03487637e-01   # N_{3,3}
  3  4     7.08271637e-01   # N_{3,4}
  4  1    -7.74381705e-02   # N_{4,1}
  4  2     2.46230989e-01   # N_{4,2}
  4  3     6.75143701e-01   # N_{4,3}
  4  4    -6.91053263e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.55551792e-01   # U_{1,1}
  1  2    -2.94823289e-01   # U_{1,2}
  2  1     2.94823289e-01   # U_{2,1}
  2  2     9.55551792e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.79494068e-01   # V_{1,1}
  1  2    -2.01473002e-01   # V_{1,2}
  2  1     2.01473002e-01   # V_{2,1}
...
Block hmix Q= 1.11563760e+03 # Higgs mixing parameters
     1     6.23972294e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.11563760e+03  # MSSM DRbar SUSY breaking parameters
    ...
    46     9.92264649e+02      # mtR(Q)
    47     1.40292120e+03      # mdR(Q)
    48     1.40291613e+03      # msR(Q)
    49     1.39319941e+03      # mbR(Q)
Block au Q= 1.11563760e+03  
  1  1    -1.11892470e+03      # Au(Q)MSSM DRbar
  2  2    -1.11891972e+03      # Ac(Q)MSSM DRbar
  3  3    -8.63683715e+02      # At(Q)MSSM DRbar
Block ad Q= 1.11563760e+03  
  1  1    -1.36814113e+03      # Ad(Q)MSSM DRbar
  2  2    -1.36813654e+03      # As(Q)MSSM DRbar
  3  3    -1.27848767e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.11563760e+03  
  1  1    -2.97143868e+02      # Ae(Q)MSSM DRbar
  2  2    -2.97138581e+02      # Amu(Q)MSSM DRbar
  3  3    -2.95567130e+02      # Atau(Q)MSSM DRbar

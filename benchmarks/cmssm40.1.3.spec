...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.76224240e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=6.82030729e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03891581e+01   # MW
        25     1.17909216e+02   # h0
        35     7.09001927e+02   # H0
        36     7.09009019e+02   # A0
        37     7.13866300e+02   # H+
   1000021     1.36311078e+03   # ~g
   1000022     2.50491292e+02   # ~neutralino(1)
   1000023     4.76950548e+02   # ~neutralino(2)
   1000024     4.77088166e+02   # ~chargino(1)
   1000025    -8.08654250e+02   # ~neutralino(3)
   1000035     8.16410179e+02   # ~neutralino(4)
   1000037     8.17389377e+02   # ~chargino(2)
   1000001     1.28924877e+03   # ~d_L
   1000002     1.28691130e+03   # ~u_L
   1000003     1.28921228e+03   # ~s_L
   1000004     1.28687473e+03   # ~c_L
   1000005     1.08432310e+03   # ~b_1
   1000006     9.34125661e+02   # ~t_1
   1000011     5.41168329e+02   # ~e_L
   1000012     5.35055678e+02   # ~nue_L
   1000013     5.41029422e+02   # ~mu_L
   1000014     5.34915297e+02   # ~numu_L
   1000015     2.51485756e+02   # ~stau_1
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -7.78812776e-03   # N_{1,2}
  1  3     6.25039268e-02   # N_{1,3}
  1  4    -2.11731959e-02   # N_{1,4}
  2  1     1.88492886e-02   # N_{2,1}
  2  2     9.84770813e-01   # N_{2,2}
  2  3    -1.47913541e-01   # N_{2,3}
  2  4     8.94021000e-02   # N_{2,4}
  3  1    -2.87906388e-02   # N_{3,1}
  3  2     4.21298172e-02   # N_{3,2}
  3  3     7.04606597e-01   # N_{3,3}
  3  4     7.07761063e-01   # N_{3,4}
  4  1    -5.68463144e-02   # N_{4,1}
  4  2     1.68495906e-01   # N_{4,2}
  4  3     6.91190558e-01   # N_{4,3}
  4  4    -7.00452167e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.77585652e-01   # U_{1,1}
  1  2    -2.10538101e-01   # U_{1,2}
  2  1     2.10538101e-01   # U_{2,1}
  2  2     9.77585652e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91813916e-01   # V_{1,1}
  1  2    -1.27691643e-01   # V_{1,2}
  2  1     1.27691643e-01   # V_{2,1}
  2  2     9.91813916e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.35434851e-01   # F_{11}
  1  2     9.00220245e-01   # F_{12}
  2  1     9.00220245e-01   # F_{21}
  2  2    -4.35434851e-01   # F_{22}
...
Block yu Q= 1.00889492e+03  
  3  3     8.50573350e-01   # Yt(Q)MSSM DRbar
...
Block ae Q= 1.00889492e+03  
  ...
  2  2    -6.65673911e+02      # Amu(Q)MSSM DRbar

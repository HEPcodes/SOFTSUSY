...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.13387647e-04
...
# PDG code     mass             particle
   ...
   1000025    -3.48795906e+02   # ~neutralino(3)
   1000035     4.24312666e+02   # ~neutralino(4)
   ...
   1000016     2.82353331e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -5.39598427e-02   # N_{1,2}
  1  3     2.00087514e-01   # N_{1,3}
  1  4    -1.17362869e-01   # N_{1,4}
  2  1    -2.12026469e-01   # N_{2,1}
  2  2    -6.13821903e-01   # N_{2,2}
  2  3     5.65302800e-01   # N_{2,3}
  2  4    -5.08625788e-01   # N_{2,4}
  3  1    -5.38952721e-02   # N_{3,1}
  3  2     7.26909760e-02   # N_{3,2}
  3  3     6.97921800e-01   # N_{3,3}
  3  4     7.10434010e-01   # N_{3,4}
  4  1    -9.41318065e-02   # N_{4,1}
  4  2     7.84236590e-01   # N_{4,2}
  4  3     3.91539133e-01   # N_{4,3}
  4  4    -4.72026780e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -5.51745831e-01   # U_{1,1}
  1  2     8.34012313e-01   # U_{1,2}
  2  1    -8.34012313e-01   # U_{2,1}
  2  2    -5.51745831e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -6.66166131e-01   # V_{1,1}
  1  2     7.45803383e-01   # V_{1,2}
  2  1    -7.45803383e-01   # V_{2,1}
  2  2    -6.66166131e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.32992300e-01   # F_{11}
  1  2     9.42929546e-01   # F_{12}
  2  1     9.42929546e-01   # F_{21}
  2  2    -3.32992300e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     5.36922393e-01   # F_{11}
  1  2     8.43631640e-01   # F_{12}
  2  1     8.43631640e-01   # F_{21}
  2  2    -5.36922393e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.35363476e-01   # F_{11}
  1  2     9.90796008e-01   # F_{12}
  2  1     9.90796008e-01   # F_{21}
  2  2    -1.35363476e-01   # F_{22}
...
Block msoft Q= 9.11117942e+02  # MSSM DRbar SUSY breaking parameters
    ...
    21     7.05612299e+04      # mH1^2(Q)
    22    -1.02349605e+05      # mH2^2(Q)
...
Block ae Q= 9.11117942e+02  
  ...
  2  2    -3.07529100e+01      # Amu(Q)MSSM DRbar
  3  3    -3.06839977e+01      # Atau(Q)MSSM DRbar

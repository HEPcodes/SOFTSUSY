...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.84678081e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.70324399e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03950920e+01   # MW
        25     1.15549973e+02   # h0
        35     8.03087864e+02   # H0
        36     8.02826537e+02   # A0
        37     8.07093717e+02   # H+
   1000021     1.25474379e+03   # ~g
   1000022     2.26322392e+02   # ~neutralino(1)
   1000023     4.28040729e+02   # ~neutralino(2)
   1000024     4.28082074e+02   # ~chargino(1)
   1000025    -6.90977641e+02   # ~neutralino(3)
   1000035     7.03991951e+02   # ~neutralino(4)
   1000037     7.04268107e+02   # ~chargino(2)
   1000001     1.16475381e+03   # ~d_L
   1000002     1.16219940e+03   # ~u_L
   1000003     1.16475093e+03   # ~s_L
   1000004     1.16219651e+03   # ~c_L
   1000005     1.06445357e+03   # ~b_1
   1000006     8.88690399e+02   # ~t_1
   ...
   1000016     4.25662317e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.47835507e-02   # N_{1,2}
  1  3     7.63244099e-02   # N_{1,3}
  1  4    -3.21124297e-02   # N_{1,4}
  2  1     3.28907560e-02   # N_{2,1}
  2  2     9.73482577e-01   # N_{2,2}
  2  3    -1.87432031e-01   # N_{2,3}
  2  4     1.26961036e-01   # N_{2,4}
  3  1    -3.04492122e-02   # N_{3,1}
  3  2     4.42276178e-02   # N_{3,2}
  3  3     7.04034456e-01   # N_{3,3}
  3  4     7.08132931e-01   # N_{3,4}
  4  1    -7.11773890e-02   # N_{4,1}
  4  2     2.23957668e-01   # N_{4,2}
  4  3     6.80719694e-01   # N_{4,3}
  4  4    -6.93828105e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.63400272e-01   # U_{1,1}
  1  2    -2.68066998e-01   # U_{1,2}
  2  1     2.68066998e-01   # U_{2,1}
  2  2     9.63400272e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.83264861e-01   # V_{1,1}
  1  2    -1.82181811e-01   # V_{1,2}
  2  1     1.82181811e-01   # V_{2,1}
...
Block msoft Q= 9.61499318e+02  # MSSM DRbar SUSY breaking parameters
    ...
    42     1.12481013e+03      # mqL2(Q)
    43     1.03424045e+03      # mqL3(Q)
    44     1.08341274e+03      # muR(Q)
    45     1.08340959e+03      # mcR(Q)
    46     8.86461889e+02      # mtR(Q)
    47     1.07838691e+03      # mdR(Q)
    48     1.07838385e+03      # msR(Q)
    49     1.07279142e+03      # mbR(Q)
Block au Q= 9.61499318e+02  
  1  1    -1.24195615e+03      # Au(Q)MSSM DRbar
  2  2    -1.24195060e+03      # Ac(Q)MSSM DRbar
  3  3    -9.59582067e+02      # At(Q)MSSM DRbar
Block ad Q= 9.61499318e+02  
  1  1    -1.51788828e+03      # Ad(Q)MSSM DRbar
  2  2    -1.51788314e+03      # As(Q)MSSM DRbar
  3  3    -1.41875739e+03      # Ab(Q)MSSM DRbar
Block ae Q= 9.61499318e+02  
  1  1    -3.27865232e+02      # Ae(Q)MSSM DRbar
  2  2    -3.27859376e+02      # Amu(Q)MSSM DRbar
  3  3    -3.26091752e+02      # Atau(Q)MSSM DRbar

...
# PDG code     mass             particle
   ...
   1000016     3.79523143e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.44148644e-02   # N_{1,2}
  1  3     1.60135123e-01   # N_{1,3}
  1  4    -9.83779478e-02   # N_{1,4}
  2  1    -1.73762867e-01   # N_{2,1}
  2  2    -5.35968451e-01   # N_{2,2}
  2  3     6.02938757e-01   # N_{2,3}
  2  4    -5.64808942e-01   # N_{2,4}
  3  1    -4.14532664e-02   # N_{3,1}
  3  2     5.54996573e-02   # N_{3,2}
  3  3     7.01670060e-01   # N_{3,3}
  3  4     7.09126604e-01   # N_{3,4}
  4  1    -6.77787134e-02   # N_{4,1}
  4  2     8.41708515e-01   # N_{4,2}
  4  3     3.44210290e-01   # N_{4,3}
  4  4    -4.10429162e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -4.84019997e-01   # U_{1,1}
  1  2     8.75056937e-01   # U_{1,2}
  2  1    -8.75056937e-01   # U_{2,1}
  2  2    -4.84019997e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -5.77642835e-01   # V_{1,1}
  1  2     8.16289627e-01   # V_{1,2}
  2  1    -8.16289627e-01   # V_{2,1}
  2  2    -5.77642835e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.34666268e-01   # F_{11}
  1  2     9.00591603e-01   # F_{12}
  2  1     9.00591603e-01   # F_{21}
  2  2    -4.34666268e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     9.99809313e-02   # F_{11}
  1  2     9.94989353e-01   # F_{12}
  2  1     9.94989353e-01   # F_{21}
  2  2    -9.99809313e-02   # F_{22}
...
Block hmix Q= 1.17949416e+03 # Higgs mixing parameters
     1     4.36021319e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.17949416e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21     1.25535790e+05      # mH1^2(Q)
    22    -1.64235959e+05      # mH2^2(Q)
    31     3.78643389e+02      # meL(Q)
    32     3.78641774e+02      # mmuL(Q)
...
Block au Q= 1.17949416e+03  
  ...
  3  3    -3.67430978e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.17949416e+03  
  1  1    -4.10936999e+01      # Ae(Q)MSSM DRbar
  2  2    -4.10934007e+01      # Amu(Q)MSSM DRbar
  3  3    -4.10012229e+01      # Atau(Q)MSSM DRbar

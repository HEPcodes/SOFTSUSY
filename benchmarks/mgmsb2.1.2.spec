...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.57757277e-04
...
# PDG code     mass             particle
   ...
   1000024     2.35191010e+02   # ~chargino(1)
   ...
   1000011     2.87084799e+02   # ~e_L
   1000012     2.75582764e+02   # ~nue_L
   1000013     2.87083579e+02   # ~mu_L
   1000014     2.75581496e+02   # ~numu_L
...
Block alpha                     # Effective Higgs mixing parameter
          -7.74383829e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.80370672e-01   # N_{1,1}
  1  2    -5.18276081e-02   # N_{1,2}
  1  3     1.73489322e-01   # N_{1,3}
  1  4    -7.80301192e-02   # N_{1,4}
  2  1     1.38974382e-01   # N_{2,1}
  2  2     8.58393577e-01   # N_{2,2}
  2  3    -3.96532863e-01   # N_{2,3}
  2  4     2.94292842e-01   # N_{2,4}
  3  1    -6.18463461e-02   # N_{3,1}
  3  2     8.75444868e-02   # N_{3,2}
  3  3     6.95288155e-01   # N_{3,3}
  3  4     7.10693586e-01   # N_{3,4}
  4  1    -1.25437218e-01   # N_{4,1}
  4  2     5.02802475e-01   # N_{4,2}
  4  3     5.73792232e-01   # N_{4,3}
  4  4    -6.34206315e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.13132628e-01   # U_{1,1}
  1  2    -5.82078457e-01   # U_{1,2}
  2  1     5.82078457e-01   # U_{2,1}
  2  2     8.13132628e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.01626011e-01   # V_{1,1}
  1  2    -4.32516516e-01   # V_{1,2}
  2  1     4.32516516e-01   # V_{2,1}
  2  2     9.01626011e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.00722392e-01   # F_{11}
  1  2     9.53711719e-01   # F_{12}
  2  1     9.53711719e-01   # F_{21}
  2  2    -3.00722392e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     5.10097804e-01   # F_{11}
  1  2     8.60116405e-01   # F_{12}
  2  1     8.60116405e-01   # F_{21}
  2  2    -5.10097804e-01   # F_{22}
...
Block hmix Q= 8.53510045e+02 # Higgs mixing parameters
     1     3.27672702e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 8.53510045e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     2.58077436e+02      # M_2(Q)
     3     7.13548581e+02      # M_3(Q)
    21     6.86370752e+04      # mH1^2(Q)
    22    -9.55096011e+04      # mH2^2(Q)
    31     2.80612694e+02      # meL(Q)
    32     2.80611444e+02      # mmuL(Q)
    33     2.80230188e+02      # mtauL(Q)
    34     1.33295299e+02      # meR(Q)
...
Block ae Q= 8.53510045e+02  
  1  1    -2.19386493e+01      # Ae(Q)MSSM DRbar

...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.36623596e-04
...
# PDG code     mass             particle
   ...
   1000023     4.38363475e+02   # ~neutralino(2)
   1000024     4.38499951e+02   # ~chargino(1)
   1000025    -8.78017655e+02   # ~neutralino(3)
   1000035     8.84575579e+02   # ~neutralino(4)
   1000037     8.85312019e+02   # ~chargino(2)
   ...
   1000011     7.52700333e+02   # ~e_L
   1000012     7.48204745e+02   # ~nue_L
   1000013     7.52684483e+02   # ~mu_L
   1000014     7.48188808e+02   # ~numu_L
   1000015     4.95092389e+02   # ~stau_1
   1000016     7.42989663e+02   # ~nu_tau_L
...
Block Umix                  # chargino U mixing matrix 
  1  1     9.85132516e-01   # U_{1,1}
  1  2    -1.71796173e-01   # U_{1,2}
  2  1     1.71796173e-01   # U_{2,1}
  2  2     9.85132516e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.95564674e-01   # V_{1,1}
  1  2    -9.40796500e-02   # V_{1,2}
  2  1     9.40796500e-02   # V_{2,1}
  2  2     9.95564674e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     1.76678669e-01   # F_{11}
  1  2     9.84268585e-01   # F_{12}
  2  1     9.84268585e-01   # F_{21}
  2  2    -1.76678669e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.87294401e-01   # F_{11}
  1  2     9.21956098e-01   # F_{12}
  2  1     9.21956098e-01   # F_{21}
  2  2    -3.87294401e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     7.40722491e-02   # F_{11}
  1  2     9.97252878e-01   # F_{12}
  2  1     9.97252878e-01   # F_{21}
  2  2    -7.40722491e-02   # F_{22}
Block gauge Q= 1.21064741e+03  # SM gauge couplings
     1     3.62925551e-01   # g'(Q)MSSM DRbar
     2     6.41435483e-01   # g(Q)MSSM DRbar
...
Block hmix Q= 1.21064741e+03 # Higgs mixing parameters
     1     8.71564848e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.21064741e+03  # MSSM DRbar SUSY breaking parameters
     ...
     2     4.26885297e+02      # M_2(Q)
     3     1.16096881e+03      # M_3(Q)
    21     4.80639214e+05      # mH1^2(Q)
    22    -7.33080763e+05      # mH2^2(Q)
    31     7.48885987e+02      # meL(Q)
    32     7.48870062e+02      # mmuL(Q)
    33     7.44006484e+02      # mtauL(Q)
    34     5.06910708e+02      # meR(Q)
    35     5.06863336e+02      # mmuR(Q)
    36     4.92227249e+02      # mtauR(Q)
...
Block ae Q= 1.21064741e+03  
  ...
  3  3    -2.37634292e+02      # Atau(Q)MSSM DRbar

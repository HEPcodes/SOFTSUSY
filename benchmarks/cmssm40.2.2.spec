...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.95484151e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=6.15438189e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03905664e+01   # MW
        25     1.17107081e+02   # h0
        35     6.90304988e+02   # H0
        36     6.90309473e+02   # A0
        37     6.95366663e+02   # H+
   1000021     1.17095700e+03   # ~g
   1000022     2.08190433e+02   # ~neutralino(1)
   1000023     3.97021906e+02   # ~neutralino(2)
   1000024     3.97146957e+02   # ~chargino(1)
   1000025    -6.97379042e+02   # ~neutralino(3)
   1000035     7.05939303e+02   # ~neutralino(4)
   1000037     7.07079491e+02   # ~chargino(2)
   1000001     1.20234550e+03   # ~d_L
   1000002     1.19986771e+03   # ~u_L
   1000003     1.20230839e+03   # ~s_L
   1000004     1.19983051e+03   # ~c_L
   1000005     9.90190962e+02   # ~b_1
   1000006     8.35837859e+02   # ~t_1
   1000011     6.86803108e+02   # ~e_L
   1000012     6.81870419e+02   # ~nue_L
   1000013     6.86624716e+02   # ~mu_L
   1000014     6.81690839e+02   # ~numu_L
   1000015     4.70490493e+02   # ~stau_1
   1000016     6.20896580e+02   # ~nu_tau_L
   2000001     1.16514056e+03   # ~d_R
   2000002     1.16787318e+03   # ~u_R
   2000003     1.16506769e+03   # ~s_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.03714063e-02   # N_{1,2}
  1  3     7.22800977e-02   # N_{1,3}
  1  4    -2.36532958e-02   # N_{1,4}
  2  1     2.44482385e-02   # N_{2,1}
  2  2     9.81285460e-01   # N_{2,2}
  2  3    -1.64903437e-01   # N_{2,3}
  2  4     9.63742029e-02   # N_{2,4}
  3  1    -3.37028640e-02   # N_{3,1}
  3  2     4.95636751e-02   # N_{3,2}
  3  3     7.03696598e-01   # N_{3,3}
  3  4     7.07967977e-01   # N_{3,4}
  4  1    -6.44814515e-02   # N_{4,1}
  4  2     1.85781384e-01   # N_{4,2}
  4  3     6.87308913e-01   # N_{4,3}
  4  4    -6.99238070e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.71991886e-01   # U_{1,1}
  1  2    -2.35014410e-01   # U_{1,2}
  2  1     2.35014410e-01   # U_{2,1}
  2  2     9.71991886e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.90449508e-01   # V_{1,1}
  1  2    -1.37875931e-01   # V_{1,2}
  2  1     1.37875931e-01   # V_{2,1}
...
Block staumix               # stau mixing matrix
  1  1     2.91472635e-01   # F_{11}
  1  2     9.56579167e-01   # F_{12}
  2  1     9.56579167e-01   # F_{21}
  2  2    -2.91472635e-01   # F_{22}
Block gauge Q= 9.09329853e+02  # SM gauge couplings
     1     3.62083237e-01   # g'(Q)MSSM DRbar
     2     6.41966864e-01   # g(Q)MSSM DRbar
     3     1.05866877e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.09329853e+02  
  3  3     8.55106946e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.09329853e+02  
  3  3     4.96923586e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.09329853e+02  
  3  3     4.23632990e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.09329853e+02 # Higgs mixing parameters
     1     6.92874461e+02    # mu(Q)MSSM DRbar
     2     3.92246833e+01    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.43959952e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
     4     6.09296266e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.09329853e+02  # MSSM DRbar SUSY breaking parameters
     1     2.10820269e+02      # M_1(Q)
     2     3.91199545e+02      # M_2(Q)
     3     1.11446203e+03      # M_3(Q)
    21     6.23654735e+03      # mH1^2(Q)
    22    -4.71933991e+05      # mH2^2(Q)

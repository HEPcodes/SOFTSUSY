...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.67790036e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.86742841e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03934019e+01   # MW
        25     1.17040201e+02   # h0
        35     9.77200469e+02   # H0
        36     9.76997447e+02   # A0
        37     9.80509838e+02   # H+
   1000021     1.56472040e+03   # ~g
   1000022     2.91383738e+02   # ~neutralino(1)
   1000023     5.51268612e+02   # ~neutralino(2)
   1000024     5.51360734e+02   # ~chargino(1)
   1000025    -8.53787796e+02   # ~neutralino(3)
   1000035     8.65236863e+02   # ~neutralino(4)
   1000037     8.65432671e+02   # ~chargino(2)
   1000001     1.43572556e+03   # ~d_L
   1000002     1.43368236e+03   # ~u_L
   1000003     1.43572211e+03   # ~s_L
   1000004     1.43367890e+03   # ~c_L
   1000005     1.31647419e+03   # ~b_1
   1000006     1.10970143e+03   # ~t_1
   1000011     5.01771934e+02   # ~e_L
   1000012     4.95320227e+02   # ~nue_L
   1000013     5.01767462e+02   # ~mu_L
   1000014     4.95315699e+02   # ~numu_L
   1000015     3.11187549e+02   # ~stau_1
   1000016     4.93733039e+02   # ~nu_tau_L
   2000001     1.37264717e+03   # ~d_R
   2000002     1.37815907e+03   # ~u_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -9.67123640e-03   # N_{1,2}
  1  3     6.18910736e-02   # N_{1,3}
  1  4    -2.68196551e-02   # N_{1,4}
  2  1     2.25768094e-02   # N_{2,1}
  2  2     9.80061090e-01   # N_{2,2}
  2  3    -1.61744245e-01   # N_{2,3}
  2  4     1.13178381e-01   # N_{2,4}
  3  1    -2.43756963e-02   # N_{3,1}
  3  2     3.51992842e-02   # N_{3,2}
  3  3     7.05138296e-01   # N_{3,3}
  3  4     7.07775967e-01   # N_{3,4}
  4  1    -5.94932334e-02   # N_{4,1}
  4  2     1.95314456e-01   # N_{4,2}
  4  3     6.87596014e-01   # N_{4,3}
  4  4    -6.96795910e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.73075612e-01   # U_{1,1}
  1  2    -2.30486125e-01   # U_{1,2}
  2  1     2.30486125e-01   # U_{2,1}
  2  2     9.73075612e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.86845600e-01   # V_{1,1}
  1  2    -1.61665587e-01   # V_{1,2}
  2  1     1.61665587e-01   # V_{2,1}
...
Block au Q= 1.18926641e+03  
  ...
  3  3    -1.19569031e+03      # At(Q)MSSM DRbar
Block ad Q= 1.18926641e+03  
  1  1    -1.87905476e+03      # Ad(Q)MSSM DRbar
  2  2    -1.87904846e+03      # As(Q)MSSM DRbar
  3  3    -1.75759887e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.18926641e+03  
  1  1    -4.12741913e+02      # Ae(Q)MSSM DRbar
  2  2    -4.12734647e+02      # Amu(Q)MSSM DRbar
  3  3    -4.10535592e+02      # Atau(Q)MSSM DRbar

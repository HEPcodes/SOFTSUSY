...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.76385167e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.11810570e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03945126e+01   # MW
        25     1.16085532e+02   # h0
        35     8.48769231e+02   # H0
        36     8.48536748e+02   # A0
        37     8.52558309e+02   # H+
   1000021     1.35667045e+03   # ~g
   1000022     2.47689444e+02   # ~neutralino(1)
   1000023     4.68638801e+02   # ~neutralino(2)
   1000024     4.68701491e+02   # ~chargino(1)
   1000025    -7.45754756e+02   # ~neutralino(3)
   1000035     7.58164404e+02   # ~neutralino(4)
   1000037     7.58410230e+02   # ~chargino(2)
   1000001     1.24670821e+03   # ~d_L
   1000002     1.24433108e+03   # ~u_L
   1000003     1.24670519e+03   # ~s_L
   1000004     1.24432806e+03   # ~c_L
   1000005     1.14234954e+03   # ~b_1
   1000006     9.58226036e+02   # ~t_1
   1000011     4.31793772e+02   # ~e_L
   1000012     4.24323007e+02   # ~nue_L
   1000013     4.31789898e+02   # ~mu_L
   1000014     4.24319068e+02   # ~numu_L
   1000015     2.66973739e+02   # ~stau_1
   1000016     4.22941983e+02   # ~nu_tau_L
   2000001     1.19293707e+03   # ~d_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.26748386e-02   # N_{1,2}
  1  3     7.06798500e-02   # N_{1,3}
  1  4    -3.00363477e-02   # N_{1,4}
  2  1     2.86653148e-02   # N_{2,1}
  2  2     9.76134566e-01   # N_{2,2}
  2  3    -1.77579339e-01   # N_{2,3}
  2  4     1.21676565e-01   # N_{2,4}
  3  1    -2.80967645e-02   # N_{3,1}
  3  2     4.07347919e-02   # N_{3,2}
  3  3     7.04489163e-01   # N_{3,3}
  3  4     7.07987478e-01   # N_{3,4}
  4  1    -6.66884283e-02   # N_{4,1}
  4  2     2.12935046e-01   # N_{4,2}
  4  3     6.83494665e-01   # N_{4,3}
  4  4    -6.95015369e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.67359917e-01   # U_{1,1}
  1  2    -2.53406376e-01   # U_{1,2}
  2  1     2.53406376e-01   # U_{2,1}
  2  2     9.67359917e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.84730687e-01   # V_{1,1}
  1  2    -1.74084672e-01   # V_{1,2}
  2  1     1.74084672e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     1.92100068e-01   # F_{12}
  2  1    -1.92100068e-01   # F_{21}
...
Block ae Q= 1.03280996e+03  
  1  1    -3.56259934e+02      # Ae(Q)MSSM DRbar
  2  2    -3.56253604e+02      # Amu(Q)MSSM DRbar
  3  3    -3.54341105e+02      # Atau(Q)MSSM DRbar

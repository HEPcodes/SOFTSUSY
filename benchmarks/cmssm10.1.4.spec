...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.71847260e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.46893198e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03938777e+01   # MW
        25     1.16587328e+02   # h0
        35     9.13243268e+02   # H0
        36     9.13026838e+02   # A0
        37     9.16774712e+02   # H+
   1000021     1.46095546e+03   # ~g
   1000022     2.69508482e+02   # ~neutralino(1)
   1000023     5.09957108e+02   # ~neutralino(2)
   1000024     5.10036350e+02   # ~chargino(1)
   1000025    -8.00033314e+02   # ~neutralino(3)
   1000035     8.11933096e+02   # ~neutralino(4)
   1000037     8.12151188e+02   # ~chargino(2)
   ...
   1000011     4.66794970e+02   # ~e_L
   1000012     4.59873231e+02   # ~nue_L
   1000013     4.66790796e+02   # ~mu_L
   1000014     4.59868997e+02   # ~numu_L
   1000015     2.89085639e+02   # ~stau_1
   1000016     4.58388679e+02   # ~nu_tau_L
   2000001     1.28307314e+03   # ~d_R
   2000002     1.28804488e+03   # ~u_R
   2000003     1.28306976e+03   # ~s_R
   2000004     1.28804140e+03   # ~c_R
   2000005     1.27806323e+03   # ~b_2
   2000006     1.26686160e+03   # ~t_2
   2000011     2.96258024e+02   # ~e_R
   2000013     2.96244683e+02   # ~mu_R
   2000015     4.67034717e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -1.05698100e-01       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.97360032e-01   # N_{1,1}
  1  2    -1.10118035e-02   # N_{1,2}
  1  3     6.59546976e-02   # N_{1,3}
  1  4    -2.83140202e-02   # N_{1,4}
  2  1     2.53147529e-02   # N_{2,1}
  2  2     9.78267936e-01   # N_{2,2}
  2  3    -1.69164828e-01   # N_{2,3}
  2  4     1.17193297e-01   # N_{2,4}
  3  1    -2.60985645e-02   # N_{3,1}
  3  2     3.77593025e-02   # N_{3,2}
  3  3     7.04849287e-01   # N_{3,3}
  3  4     7.07870456e-01   # N_{3,4}
  4  1    -6.28569321e-02   # N_{4,1}
  4  2     2.03580009e-01   # N_{4,2}
  4  3     6.85726419e-01   # N_{4,3}
  4  4    -6.95976627e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.70473583e-01   # U_{1,1}
  1  2    -2.41207432e-01   # U_{1,2}
  2  1     2.41207432e-01   # U_{2,1}
  2  2     9.70473583e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.85869076e-01   # V_{1,1}
  1  2    -1.67517655e-01   # V_{1,2}
  2  1     1.67517655e-01   # V_{2,1}
  2  2     9.85869076e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.65959938e-01   # F_{11}
  1  2     9.30630606e-01   # F_{12}
  2  1     9.30630606e-01   # F_{21}
  2  2    -3.65959938e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     9.83398171e-01   # F_{11}
  1  2     1.81460840e-01   # F_{12}
  2  1    -1.81460840e-01   # F_{21}
  2  2     9.83398171e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.08704490e-01   # F_{11}
  1  2     9.94074109e-01   # F_{12}
  2  1     9.94074109e-01   # F_{21}
  2  2    -1.08704490e-01   # F_{22}
...
Block ae Q= 1.11123500e+03  
  1  1    -3.84551083e+02      # Ae(Q)MSSM DRbar
  2  2    -3.84544283e+02      # Amu(Q)MSSM DRbar
  3  3    -3.82487970e+02      # Atau(Q)MSSM DRbar

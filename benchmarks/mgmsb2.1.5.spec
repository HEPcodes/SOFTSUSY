...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.58149845e-06
...
# PDG code     mass             particle
   ...
   1000025    -4.29634359e+02   # ~neutralino(3)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  4    -6.31570128e-02   # N_{1,4}
  2  1     9.82589811e-02   # N_{2,1}
  2  2     8.72100090e-01   # N_{2,2}
  2  3    -3.76884800e-01   # N_{2,3}
  2  4     2.96216901e-01   # N_{2,4}
  3  1    -4.77021690e-02   # N_{3,1}
  3  2     6.70090877e-02   # N_{3,2}
  3  3     7.00097779e-01   # N_{3,3}
  3  4     7.09293581e-01   # N_{3,4}
  4  1    -1.05499368e-01   # N_{4,1}
  4  2     4.83670954e-01   # N_{4,2}
  4  3     5.91407589e-01   # N_{4,3}
  4  4    -6.36529147e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.37335342e-01   # U_{1,1}
  1  2    -5.46689605e-01   # U_{1,2}
  2  1     5.46689605e-01   # U_{2,1}
  2  2     8.37335342e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02614011e-01   # V_{1,1}
  1  2    -4.30450866e-01   # V_{1,2}
  2  1     4.30450866e-01   # V_{2,1}
  2  2     9.02614011e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.39611426e-01   # F_{11}
  1  2     9.70868871e-01   # F_{12}
  2  1     9.70868871e-01   # F_{21}
  2  2    -2.39611426e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     4.09285137e-01   # F_{11}
  1  2     9.12406530e-01   # F_{12}
  2  1     9.12406530e-01   # F_{21}
  2  2    -4.09285137e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.01465235e-01   # F_{11}
  1  2     9.94839085e-01   # F_{12}
  2  1     9.94839085e-01   # F_{21}
  2  2    -1.01465235e-01   # F_{22}
...
Block yu Q= 1.10540052e+03  
  3  3     8.60566044e-01   # Yt(Q)MSSM DRbar
...
Block hmix Q= 1.10540052e+03 # Higgs mixing parameters
     1     4.21054098e+02    # mu(Q)MSSM DRbar
...
Block au Q= 1.10540052e+03  
  ...
  3  3    -2.66576472e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.10540052e+03  
  1  1    -2.93107172e+01      # Ae(Q)MSSM DRbar
  2  2    -2.93105006e+01      # Amu(Q)MSSM DRbar

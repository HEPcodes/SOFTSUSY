...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.84442788e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.30312069e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03892151e+01   # MW
        25     1.18041012e+02   # h0
        35     8.07414349e+02   # H0
        36     8.07406066e+02   # A0
        37     8.11723031e+02   # H+
   1000021     1.38443709e+03   # ~g
   1000022     2.51959033e+02   # ~neutralino(1)
   1000023     4.79887073e+02   # ~neutralino(2)
   1000024     4.80022941e+02   # ~chargino(1)
   1000025    -8.00378723e+02   # ~neutralino(3)
   1000035     8.08686867e+02   # ~neutralino(4)
   1000037     8.09618661e+02   # ~chargino(2)
   1000001     1.41605868e+03   # ~d_L
   1000002     1.41397741e+03   # ~u_L
   ...
   1000012     8.01474230e+02   # ~nue_L
   1000013     8.05521081e+02   # ~mu_L
   1000014     8.01276388e+02   # ~numu_L
   ...
   2000004     1.37463871e+03   # ~c_R
   2000005     1.25363443e+03   # ~b_2
   2000006     1.23007903e+03   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -7.90246285e-03   # N_{1,2}
  1  3     6.33733532e-02   # N_{1,3}
  1  4    -2.17262149e-02   # N_{1,4}
  2  1     1.94547132e-02   # N_{2,1}
  2  2     9.83847333e-01   # N_{2,2}
  2  3    -1.51729764e-01   # N_{2,3}
  2  4     9.29732094e-02   # N_{2,4}
  3  1    -2.90067455e-02   # N_{3,1}
  3  2     4.23533664e-02   # N_{3,2}
  3  3     7.04589784e-01   # N_{3,3}
  3  4     7.07755634e-01   # N_{3,4}
  4  1    -5.77129282e-02   # N_{4,1}
  4  2     1.73747426e-01   # N_{4,2}
  4  3     6.90300755e-01   # N_{4,3}
  4  4    -6.99975654e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.76351377e-01   # U_{1,1}
  1  2    -2.16189707e-01   # U_{1,2}
  2  1     2.16189707e-01   # U_{2,1}
  2  2     9.76351377e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91117944e-01   # V_{1,1}
  1  2    -1.32985796e-01   # V_{1,2}
  2  1     1.32985796e-01   # V_{2,1}
  2  2     9.91117944e-01   # V_{2,2}
...
Block msoft Q= 1.07990028e+03  # MSSM DRbar SUSY breaking parameters
    ...
    41     1.37567341e+03      # mqL1(Q)
    42     1.37563058e+03      # mqL2(Q)
    43     1.15995077e+03      # mqL3(Q)
    44     1.33677101e+03      # muR(Q)
    45     1.33676554e+03      # mcR(Q)
    46     9.99597972e+02      # mtR(Q)
    47     1.33211500e+03      # mdR(Q)
    48     1.33203104e+03      # msR(Q)
    49     1.20515188e+03      # mbR(Q)
Block au Q= 1.07990028e+03  
  1  1    -1.68092116e+03      # Au(Q)MSSM DRbar
  2  2    -1.68088128e+03      # Ac(Q)MSSM DRbar
  3  3    -1.17384139e+03      # At(Q)MSSM DRbar
Block ad Q= 1.07990028e+03  
  1  1    -1.94211332e+03      # Ad(Q)MSSM DRbar
  2  2    -1.94201179e+03      # As(Q)MSSM DRbar
  3  3    -1.63436373e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.07990028e+03  
  1  1    -6.62570213e+02      # Ae(Q)MSSM DRbar
  2  2    -6.62244129e+02      # Amu(Q)MSSM DRbar
  3  3    -5.54937921e+02      # Atau(Q)MSSM DRbar

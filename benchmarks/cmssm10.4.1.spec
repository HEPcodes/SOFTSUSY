...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.31215996e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.47372522e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03987783e+01   # MW
        25     1.13054910e+02   # h0
        35     8.96427694e+02   # H0
        36     8.96374827e+02   # A0
        37     9.00038227e+02   # H+
   1000021     8.63752387e+02   # ~g
   1000022     1.41997465e+02   # ~neutralino(1)
   1000023     2.67296466e+02   # ~neutralino(2)
   1000024     2.67129098e+02   # ~chargino(1)
   1000025    -4.69573442e+02   # ~neutralino(3)
   1000035     4.86704576e+02   # ~neutralino(4)
   1000037     4.87085129e+02   # ~chargino(2)
   1000001     1.04977992e+03   # ~d_L
   1000002     1.04696076e+03   # ~u_L
   1000003     1.04977625e+03   # ~s_L
   1000004     1.04695708e+03   # ~c_L
   1000005     9.10481641e+02   # ~b_1
   1000006     7.24391616e+02   # ~t_1
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.20280590e-02   # N_{1,2}
  1  3     1.13882116e-01   # N_{1,3}
  1  4    -4.52569224e-02   # N_{1,4}
  2  1     6.60357117e-02   # N_{2,1}
  2  2     9.54711706e-01   # N_{2,2}
  2  3    -2.44849979e-01   # N_{2,3}
  2  4     1.55606334e-01   # N_{2,4}
  3  1    -4.58679716e-02   # N_{3,1}
  3  2     6.71693159e-02   # N_{3,2}
  3  3     7.00264730e-01   # N_{3,3}
  3  4     7.09234601e-01   # N_{3,4}
  4  1    -9.78699951e-02   # N_{4,1}
  4  2     2.88076457e-01   # N_{4,2}
  4  3     6.60839359e-01   # N_{4,3}
  4  4    -6.86093842e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.35275225e-01   # U_{1,1}
  1  2    -3.53921252e-01   # U_{1,2}
  2  1     3.53921252e-01   # U_{2,1}
  2  2     9.35275225e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.74109952e-01   # V_{1,1}
  1  2    -2.26074768e-01   # V_{1,2}
  2  1     2.26074768e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     5.94733364e-02   # F_{12}
  2  1    -5.94733364e-02   # F_{21}
...
Block msoft Q= 8.02091845e+02  # MSSM DRbar SUSY breaking parameters
    ...
    43     8.88829655e+02      # mqL3(Q)
    44     1.00893184e+03      # muR(Q)
    45     1.00892778e+03      # mcR(Q)
    46     7.09011823e+02      # mtR(Q)
    47     1.00708183e+03      # mdR(Q)
    48     1.00707814e+03      # msR(Q)
    49     9.99953422e+02      # mbR(Q)
Block au Q= 8.02091845e+02  
  1  1    -8.13408640e+02      # Au(Q)MSSM DRbar
  2  2    -8.13404971e+02      # Ac(Q)MSSM DRbar
  3  3    -6.24368814e+02      # At(Q)MSSM DRbar
Block ad Q= 8.02091845e+02  
  1  1    -9.98740061e+02      # Ad(Q)MSSM DRbar
  2  2    -9.98736656e+02      # As(Q)MSSM DRbar
  3  3    -9.32302528e+02      # Ab(Q)MSSM DRbar
Block ae Q= 8.02091845e+02  
  1  1    -2.11356060e+02      # Ae(Q)MSSM DRbar
  2  2    -2.11352218e+02      # Amu(Q)MSSM DRbar
  3  3    -2.10214433e+02      # Atau(Q)MSSM DRbar

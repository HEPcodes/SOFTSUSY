...
Block RVUMIX  # lepton-chargino mixing matrix U
  ...
  4 4    9.60099520e-01   # U_{44}
  4 5   -2.79658563e-01   # U_{45}
  5 1    0.00000000e+00   # U_{51}
  5 2    0.00000000e+00   # U_{52}
  5 3    0.00000000e+00   # U_{53}
  5 4    2.79658563e-01   # U_{54}
  5 5    9.60099520e-01   # U_{55}
Block RVVMIX  # lepton-chargino mixing matrix V
  ...
  4 5   -1.82376088e-01   # V_{45}
  5 1    0.00000000e+00   # V_{51}
  5 2    0.00000000e+00   # V_{52}
  5 3    0.00000000e+00   # V_{53}
  5 4    1.82376088e-01   # V_{54}
  5 5    9.83228845e-01   # V_{55}
Block gauge Q= 8.76220270e+02  # SM gauge couplings
     1     3.62703232e-01   # g'(Q)MSSM DRbar
     2     6.42357191e-01   # g(Q)MSSM DRbar
     3     1.06432994e+00   # g3(Q)MSSM DRbar
Block yu Q= 8.76220270e+02   # diagonal Up Yukawa matrix
  1  1     7.33179837e-06    # YU_{11}(Q)MSSM DRbar
  2  2     3.35849916e-03    # YU_{22}(Q)MSSM DRbar
  3  3     8.57821195e-01    # YU_{33}(Q)MSSM DRbar
Block yd Q= 8.76220270e+02   # diagonal down Yukawa matrix
  1  1     1.41236810e-04    # YD_{11}(Q)MSSM DRbar
  2  2     3.09240175e-03    # YD_{22}(Q)MSSM DRbar
  3  3     1.34889355e-01    # YD_{33}(Q)MSSM DRbar
Block ye Q= 8.76220270e+02   # diagonal lepton Yukawa matrix
  1  1     2.79077047e-05    # YE_{11}(Q)MSSM DRbar
  2  2     5.77043620e-03    # YE_{22}(Q)MSSM DRbar
  3  3     1.00319812e-01    # YE_{33}(Q)MSSM DRbar
Block hmix Q= 8.76220270e+02 # Higgs mixing parameters
     1     6.36136670e+02    # mu(Q)MSSM DRbar
     2     9.67533422e+00    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.44501979e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
     4     5.31425609e+05    # mA^2(Q)MSSM DRbar
Block RVLAMLLE Q= 8.76220270e+02 # non-zero R-Parity violating LLE couplings 
Block RVLAMLQD Q= 8.76220270e+02 # non-zero R-Parity violating LQD couplings 
Block RVLAMUDD Q= 8.76220270e+02 # non-zero R-Parity violating UDD couplings 
  1 1 2    3.94685824e-19   # lambda''_{112}
  1 1 3    3.90298954e-22   # lambda''_{113}
  1 2 1   -3.94685824e-19   # lambda''_{121}
  1 2 3    1.00000986e-04   # lambda''_{123}
  1 3 1   -3.90298954e-22   # lambda''_{131}
  1 3 2   -1.00000986e-04   # lambda''_{132}
  2 1 2   -8.06039086e-27   # lambda''_{212}
  2 1 3   -7.84097410e-30   # lambda''_{213}
  2 2 1    8.06039086e-27   # lambda''_{221}
  2 2 3    3.78730212e-14   # lambda''_{223}
  2 3 1    7.84097410e-30   # lambda''_{231}
  2 3 2   -3.78730212e-14   # lambda''_{232}
  3 1 2    1.87016622e-25   # lambda''_{312}
  3 1 3    1.81917375e-28   # lambda''_{313}
  3 2 1   -1.87016622e-25   # lambda''_{321}
  3 2 3   -8.87728190e-13   # lambda''_{323}
  3 3 1   -1.81917375e-28   # lambda''_{331}
  3 3 2    8.87728190e-13   # lambda''_{332}
Block RVTLLE Q= 8.76220270e+02 # non-zero R-Parity violating LLE soft terms 
Block RVTLQD Q= 8.76220270e+02 # non-zero R-Parity violating LQD soft terms 
Block RVTUDD Q= 8.76220270e+02 # non-zero R-Parity violating UDD soft terms 
  1 1 2    2.68911753e-15   # T''_{112}
  1 1 3    2.64086968e-18   # T''_{113}
  1 2 1   -2.68911753e-15   # T''_{121}
  1 2 3   -2.15663953e-06   # T''_{123}
  1 3 1   -2.64086968e-18   # T''_{131}
  1 3 2    2.15663953e-06   # T''_{132}
  2 1 2    1.01403466e-22   # T''_{212}
  2 1 3    9.86063661e-26   # T''_{213}
  2 2 1   -1.01403466e-22   # T''_{221}
  2 2 3   -6.81767531e-11   # T''_{223}
  2 3 1   -9.86063661e-26   # T''_{231}
  2 3 2    6.81767531e-11   # T''_{232}
  3 1 2   -2.34687581e-21   # T''_{312}
  3 1 3   -2.28195528e-24   # T''_{313}
  3 2 1    2.34687581e-21   # T''_{321}
  3 2 3    1.59172190e-09   # T''_{323}
  3 3 1    2.28195528e-24   # T''_{331}
  3 3 2   -1.59172190e-09   # T''_{332}
Block RVKAPPA Q= 8.76220270e+02 # R-Parity violating kappa 
     1    0.00000000e+00   # kappa_{1}
     2    0.00000000e+00   # kappa_{2}
     3    0.00000000e+00   # kappa_{3}
Block RVD Q= 8.76220270e+02 # R-Parity violating D 
     1    0.00000000e+00   # D_{1}
     2    0.00000000e+00   # D_{2}
     3    0.00000000e+00   # D_{3}
Block RVSNVEV Q= 8.76220270e+02 # sneutrino VEVs D 
     1    0.00000000e+00   # SneutrinoVev_{1}
     2    0.00000000e+00   # SneutrinoVev_{2}
     3    0.00000000e+00   # SneutrinoVev_{3}
Block RVM2LH1 Q= 8.76220270e+02 # M2LH1 
...
Block msq2 Q= 8.76220270e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     1.03725641e+06    # (m^_Q^2)_{11}
  1  2     3.57018306e+01    # (m^_Q^2)_{12}
  1  3    -8.43985934e+02    # (m^_Q^2)_{13}
  2  1     3.57018306e+01    # (m^_Q^2)_{21}
  2  2     1.03699768e+06    # (m^_Q^2)_{22}
  2  3     6.21358988e+03    # (m^_Q^2)_{23}
  3  1    -8.43985934e+02    # (m^_Q^2)_{31}
  3  2     6.21358988e+03    # (m^_Q^2)_{32}
  3  3     8.82909608e+05    # (m^_Q^2)_{33}
Block msl2 Q= 8.76220270e+02 # super MNS slepton mass^2 matrix - DRbar
  1  1     1.24792269e+05    # (m^_L^2)_{11}
...
Block msd2 Q= 8.76220270e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     9.52928639e+05    # (m^_d^2)_{11}
  1  2    -2.56063526e-06    # (m^_d^2)_{12}
  1  3     2.65132704e-03    # (m^_d^2)_{13}
  2  1    -2.56063526e-06    # (m^_d^2)_{21}
  2  2     9.52923338e+05    # (m^_d^2)_{22}
  2  3    -4.27384954e-01    # (m^_d^2)_{23}
  3  1     2.65132704e-03    # (m^_d^2)_{31}
  3  2    -4.27384954e-01    # (m^_d^2)_{32}
  3  3     9.43296754e+05    # (m^_d^2)_{33}
Block msu2 Q= 8.76220270e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     9.61895743e+05    # (m^_u^2)_{11}
  1  2     1.30617258e-03    # (m^_u^2)_{12}
  1  3    -4.45174507e-05    # (m^_u^2)_{13}
  2  1     1.30617258e-03    # (m^_u^2)_{21}
  2  2     9.61890325e+05    # (m^_u^2)_{22}
  2  3    -5.70236951e-02    # (m^_u^2)_{23}
  3  1    -4.45174507e-05    # (m^_u^2)_{31}
  3  2    -5.70236951e-02    # (m^_u^2)_{32}
  3  3     6.55128659e+05    # (m^_u^2)_{33}
Block mse2 Q= 8.76220270e+02 # super MNS slepton mass^2 matrix - DRbar
...
Block tu Q= 8.76220270e+02   # super CKM trilinear matrix - DRbar
  1  1    -8.38404263e-03    # (T^_u)_{11}
  1  2    -1.65926102e-08    # (T^_u)_{12}
  1  3    -8.99470240e-08    # (T^_u)_{13}
  2  1    -8.27952228e-06    # (T^_u)_{21}
  2  2    -3.84053641e+00    # (T^_u)_{22}
  2  3    -3.91127655e-04    # (T^_u)_{23}
  3  1    -1.11163577e-02    # (T^_u)_{31}
  3  2    -1.17984298e-01    # (T^_u)_{32}
  3  3    -7.60422845e+02    # (T^_u)_{33}
Block td Q= 8.76220270e+02   # super CKM trilinear matrix - DRbar
  1  1    -1.97008251e-01    # (T^_d)_{11}
  1  2    -2.91217841e-06    # (T^_d)_{12}
  1  3     6.92114389e-05    # (T^_d)_{13}
  2  1    -6.37623563e-05    # (T^_d)_{21}
  2  2    -4.31307461e+00    # (T^_d)_{22}
  2  3    -1.11566139e-02    # (T^_d)_{23}
  3  1     6.59728647e-02    # (T^_d)_{31}
  3  2    -4.85706026e-01    # (T^_d)_{32}
  3  3    -1.75998777e+02    # (T^_d)_{33}
Block te Q= 8.76220270e+02   # super CKM trilinear matrix - DRbar
  1  1    -8.30029734e-03    # (T^_e)_{11}
  1  2     0.00000000e+00    # (T^_e)_{12}
  1  3     0.00000000e+00    # (T^_e)_{13}
  2  1     0.00000000e+00    # (T^_e)_{21}
  2  2    -1.71620986e+00    # (T^_e)_{22}
  2  3     0.00000000e+00    # (T^_e)_{23}
  3  1     0.00000000e+00    # (T^_e)_{31}
  3  2     0.00000000e+00    # (T^_e)_{32}
  3  3    -2.96754838e+01    # (T^_e)_{33}
Block VCKM Q= 8.76220270e+02 # DRbar CKM mixing matrix
...
Block msoft Q= 8.76220270e+02 # MSSM DRbar SUSY breaking parameters
     1     2.10406831e+02     # M_1(Q)
     2     3.89202336e+02     # M_2(Q)
     3     1.11364038e+03     # M_3(Q)
    21     1.08623263e+05     # mH1^2(Q)
    22    -3.80244558e+05     # mH2^2(Q)
Block USQMIX  # super CKM squark mass^2 matrix
  1  1     2.22383949e-05   # (USQMIX)_{11}
  1  2     2.35484512e-04   # (USQMIX)_{12}
  1  3     4.29694480e-01   # (USQMIX)_{13}
  1  4     2.13122781e-10   # (USQMIX)_{14}
  1  5     6.46264837e-07   # (USQMIX)_{15}
  1  6     9.02974306e-01   # (USQMIX)_{16}
  2  1     1.63629534e-04   # (USQMIX)_{21}
  2  2     1.73195267e-03   # (USQMIX)_{22}
  2  3     9.02972787e-01   # (USQMIX)_{23}
  2  4     9.87731150e-09   # (USQMIX)_{24}
  2  5     5.03905561e-05   # (USQMIX)_{25}
  2  6    -4.29694213e-01   # (USQMIX)_{26}
  3  1     1.58685412e-07   # (USQMIX)_{31}
  3  2     8.86171671e-03   # (USQMIX)_{32}
  3  3    -6.05329941e-05   # (USQMIX)_{33}
  3  4    -1.13597377e-04   # (USQMIX)_{34}
  3  5     9.99960726e-01   # (USQMIX)_{35}
  3  6     2.57788657e-05   # (USQMIX)_{36}
  4  1     1.93461262e-05   # (USQMIX)_{41}
  4  2     1.00716373e-06   # (USQMIX)_{42}
  4  3    -1.89310860e-08   # (USQMIX)_{43}
  4  4     9.99999993e-01   # (USQMIX)_{44}
  4  5     1.13592907e-04   # (USQMIX)_{45}
  4  6     7.95222075e-09   # (USQMIX)_{46}
  5  1     1.87878213e-01   # (USQMIX)_{51}
  5  2     9.82152210e-01   # (USQMIX)_{52}
  5  3    -1.66453586e-03   # (USQMIX)_{53}
  5  4    -3.63522211e-06   # (USQMIX)_{54}
  5  5    -8.70404118e-03   # (USQMIX)_{55}
  5  6     5.31341532e-04   # (USQMIX)_{56}
  6  1     9.82192318e-01   # (USQMIX)_{61}
  6  2    -1.87870836e-01   # (USQMIX)_{62}
  6  3     1.58239173e-04   # (USQMIX)_{63}
  6  4    -1.90015034e-05   # (USQMIX)_{64}
  6  5     1.66477637e-03   # (USQMIX)_{65}
  6  6    -5.04967674e-05   # (USQMIX)_{66}
Block DSQMIX  # super CKM squark mass^2 matrix
  1  1     4.59225438e-03   # (DSQMIX)_{11}
  1  2    -3.38095929e-02   # (DSQMIX)_{12}
  1  3     9.74056211e-01   # (DSQMIX)_{13}
  1  4     9.71588823e-07   # (DSQMIX)_{14}
  1  5    -1.56628848e-04   # (DSQMIX)_{15}
  1  6     2.23719235e-01   # (DSQMIX)_{16}
  2  1    -1.78771955e-03   # (DSQMIX)_{21}
  2  2     1.31631704e-02   # (DSQMIX)_{22}
  2  3    -2.23387717e-01   # (DSQMIX)_{23}
  2  4    -2.43266159e-06   # (DSQMIX)_{24}
  2  5     3.92325277e-04   # (DSQMIX)_{25}
  2  6     9.74639066e-01   # (DSQMIX)_{26}
  3  1     1.97141562e-06   # (DSQMIX)_{31}
  3  2     4.52076652e-03   # (DSQMIX)_{32}
  3  3     4.02967412e-04   # (DSQMIX)_{33}
  3  4     5.56008625e-06   # (DSQMIX)_{34}
  3  5     9.99989631e-01   # (DSQMIX)_{35}
  3  6    -3.71221854e-04   # (DSQMIX)_{36}
  4  1     2.07140404e-04   # (DSQMIX)_{41}
  4  2     6.48366257e-08   # (DSQMIX)_{42}
  4  3    -2.50183078e-06   # (DSQMIX)_{43}
  4  4     9.99999979e-01   # (DSQMIX)_{44}
  4  5    -5.55898184e-06   # (DSQMIX)_{45}
  4  6     2.30384741e-06   # (DSQMIX)_{46}
  5  1    -1.38066929e-01   # (DSQMIX)_{51}
  5  2     9.89735749e-01   # (DSQMIX)_{52}
  5  3     3.62249407e-02   # (DSQMIX)_{53}
  5  4     2.86129804e-05   # (DSQMIX)_{54}
  5  5    -4.49070956e-03   # (DSQMIX)_{55}
  5  6    -5.31572839e-03   # (DSQMIX)_{56}
  6  1     9.90410620e-01   # (DSQMIX)_{61}
  6  2     1.38153366e-01   # (DSQMIX)_{62}
  6  3     1.30246533e-04   # (DSQMIX)_{63}
  6  4    -2.05166131e-04   # (DSQMIX)_{64}
  6  5    -6.26576555e-04   # (DSQMIX)_{65}
  6  6    -1.91035531e-05   # (DSQMIX)_{66}
...
Block RVAMIX  # CP-odd neutral scalar mixing matrix 
  ...
  4 2    1.02812481e-01   # curlyN~_{42}

...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.83946809e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.10690934e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03937842e+01   # MW
        25     1.16160912e+02   # h0
        35     9.23280845e+02   # H0
        36     9.22979251e+02   # A0
        37     9.26811785e+02   # H+
   1000021     1.36684184e+03   # ~g
   1000022     2.48797170e+02   # ~neutralino(1)
   1000023     4.70792371e+02   # ~neutralino(2)
   1000024     4.70853977e+02   # ~chargino(1)
   1000025    -7.45330955e+02   # ~neutralino(3)
   1000035     7.57876500e+02   # ~neutralino(4)
   1000037     7.58102440e+02   # ~chargino(2)
   1000001     1.29906504e+03   # ~d_L
   1000002     1.29679732e+03   # ~u_L
   1000003     1.29906169e+03   # ~s_L
   1000004     1.29679395e+03   # ~c_L
   1000005     1.18104749e+03   # ~b_1
   1000006     9.85310061e+02   # ~t_1
   1000011     5.67741388e+02   # ~e_L
   1000012     5.61992228e+02   # ~nue_L
   1000013     5.67735100e+02   # ~mu_L
   1000014     5.61985881e+02   # ~numu_L
   1000015     4.53532734e+02   # ~stau_1
   1000016     5.59924557e+02   # ~nu_tau_L
   2000001     1.24817988e+03   # ~d_R
   2000002     1.25239711e+03   # ~u_R
   2000003     1.24817642e+03   # ~s_R
   2000004     1.25239349e+03   # ~c_R
   2000005     1.24251647e+03   # ~b_2
   2000006     1.21665015e+03   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.26891078e-02   # N_{1,2}
  1  3     7.09227702e-02   # N_{1,3}
  1  4    -3.02391288e-02   # N_{1,4}
  2  1     2.88549401e-02   # N_{2,1}
  2  2     9.75790044e-01   # N_{2,2}
  2  3    -1.78665454e-01   # N_{2,3}
  2  4     1.22799995e-01   # N_{2,4}
  3  1    -2.81250886e-02   # N_{3,1}
  3  2     4.07259797e-02   # N_{3,2}
  3  3     7.04493697e-01   # N_{3,3}
  3  4     7.07982348e-01   # N_{3,4}
  4  1    -6.69464677e-02   # N_{4,1}
  4  2     2.14509141e-01   # N_{4,2}
  4  3     6.83181708e-01   # N_{4,3}
  4  4    -6.94814185e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.66792553e-01   # U_{1,1}
  1  2    -2.55562439e-01   # U_{1,2}
  2  1     2.55562439e-01   # U_{2,1}
  2  2     9.66792553e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.84338110e-01   # V_{1,1}
  1  2    -1.76290912e-01   # V_{1,2}
  2  1     1.76290912e-01   # V_{2,1}
  2  2     9.84338110e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.57644640e-01   # F_{11}
  1  2     9.33857758e-01   # F_{12}
  2  1     9.33857758e-01   # F_{21}
...
Block msoft Q= 1.06239708e+03  # MSSM DRbar SUSY breaking parameters
    ...
    46     9.76379797e+02      # mtR(Q)
    47     1.20714920e+03      # mdR(Q)
    48     1.20714567e+03      # msR(Q)
    49     1.20065993e+03      # mbR(Q)
...
Block ad Q= 1.06239708e+03  
  1  1    -1.63731696e+03      # Ad(Q)MSSM DRbar
  2  2    -1.63731144e+03      # As(Q)MSSM DRbar
  3  3    -1.53074402e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.06239708e+03  
  1  1    -3.56142033e+02      # Ae(Q)MSSM DRbar
  2  2    -3.56135706e+02      # Amu(Q)MSSM DRbar
  3  3    -3.54227372e+02      # Atau(Q)MSSM DRbar

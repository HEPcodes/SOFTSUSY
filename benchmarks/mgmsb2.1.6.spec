...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.00697924e-05
...
# PDG code     mass             particle
   ...
   1000015     1.98437502e+02   # ~stau_1
   1000016     4.01253216e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  4    -5.97365975e-02   # N_{1,4}
  2  1     8.98128286e-02   # N_{2,1}
  2  2     8.74544690e-01   # N_{2,2}
  2  3    -3.72523500e-01   # N_{2,3}
  2  4     2.97206129e-01   # N_{2,4}
  3  1    -4.43907703e-02   # N_{3,1}
  3  2     6.22240531e-02   # N_{3,2}
  3  3     7.01040334e-01   # N_{3,3}
  3  4     7.09013453e-01   # N_{3,4}
  4  1    -1.00380866e-01   # N_{4,1}
  4  2     4.80128172e-01   # N_{4,2}
  4  3     5.94979530e-01   # N_{4,3}
  4  4    -6.36710279e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.42114578e-01   # U_{1,1}
  1  2    -5.39298653e-01   # U_{1,2}
  2  1     5.39298653e-01   # U_{2,1}
  2  2     8.42114578e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02318744e-01   # V_{1,1}
  1  2    -4.31069466e-01   # V_{1,2}
  2  1     4.31069466e-01   # V_{2,1}
  2  2     9.02318744e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     3.78493865e-01   # F_{11}
  1  2     9.25603800e-01   # F_{12}
  2  1     9.25603800e-01   # F_{21}
  2  2    -3.78493865e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     9.31178409e-02   # F_{11}
  1  2     9.95655095e-01   # F_{12}
  2  1     9.95655095e-01   # F_{21}
  2  2    -9.31178409e-02   # F_{22}

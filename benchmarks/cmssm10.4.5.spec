...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.99386296e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.27661867e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03950062e+01   # MW
   ...
   1000024     4.35649460e+02   # ~chargino(1)
   1000025    -6.83300220e+02   # ~neutralino(3)
   1000035     6.97686399e+02   # ~neutralino(4)
   1000037     6.97783192e+02   # ~chargino(2)
   1000001     1.59820754e+03   # ~d_L
   1000002     1.59641123e+03   # ~u_L
   1000003     1.59820201e+03   # ~s_L
   1000004     1.59640569e+03   # ~c_L
   1000005     1.38885180e+03   # ~b_1
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.48869951e-02   # N_{1,2}
  1  3     7.79817245e-02   # N_{1,3}
  1  4    -3.33872126e-02   # N_{1,4}
  2  1     3.44296622e-02   # N_{2,1}
  2  2     9.70439307e-01   # N_{2,2}
  2  3    -1.96378942e-01   # N_{2,3}
  2  4     1.36005368e-01   # N_{2,4}
  3  1    -3.07159529e-02   # N_{3,1}
  3  2     4.43233091e-02   # N_{3,2}
  3  3     7.04051039e-01   # N_{3,3}
  3  4     7.08098941e-01   # N_{3,4}
  4  1    -7.27228063e-02   # N_{4,1}
  4  2     2.36772828e-01   # N_{4,2}
  4  3     6.77986944e-01   # N_{4,3}
  4  4    -6.92086501e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.59533330e-01   # U_{1,1}
  1  2    -2.81595080e-01   # U_{1,2}
  2  1     2.81595080e-01   # U_{2,1}
  2  2     9.59533330e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.80638941e-01   # V_{1,1}
  1  2    -1.95824586e-01   # V_{1,2}
  2  1     1.95824586e-01   # V_{2,1}
  2  2     9.80638941e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.15128687e-01   # F_{11}
  1  2     9.76585709e-01   # F_{12}
  2  1     9.76585709e-01   # F_{21}
  2  2    -2.15128687e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     9.99288753e-01   # F_{11}
  1  2     3.77092707e-02   # F_{12}
  2  1    -3.77092707e-02   # F_{21}
  2  2     9.99288753e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.24838872e-01   # F_{11}
  1  2     9.92177029e-01   # F_{12}
  2  1     9.92177029e-01   # F_{21}
  2  2    -1.24838872e-01   # F_{22}
...
Block hmix Q= 1.21970519e+03 # Higgs mixing parameters
     1     6.75496026e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.21970519e+03  # MSSM DRbar SUSY breaking parameters
     1     2.32874693e+02      # M_1(Q)
     2     4.29656906e+02      # M_2(Q)
     3     1.20216773e+03      # M_3(Q)
    21     1.37825373e+06      # mH1^2(Q)
    22    -4.12705013e+05      # mH2^2(Q)
...
Block au Q= 1.21970519e+03  
  1  1    -1.21854551e+03      # Au(Q)MSSM DRbar
  2  2    -1.21854011e+03      # Ac(Q)MSSM DRbar
  3  3    -9.41968588e+02      # At(Q)MSSM DRbar
Block ad Q= 1.21970519e+03  
  1  1    -1.48829866e+03      # Ad(Q)MSSM DRbar
  2  2    -1.48829368e+03      # As(Q)MSSM DRbar
  3  3    -1.39116537e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.21970519e+03  
  1  1    -3.25453966e+02      # Ae(Q)MSSM DRbar
  2  2    -3.25448208e+02      # Amu(Q)MSSM DRbar
  3  3    -3.23735328e+02      # Atau(Q)MSSM DRbar

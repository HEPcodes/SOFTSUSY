...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.12712620e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.87739598e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03964320e+01   # MW
        25     1.14836616e+02   # h0
        35     1.13080477e+03   # H0
        36     1.13075634e+03   # A0
        37     1.13370507e+03   # H+
   1000021     1.08804632e+03   # ~g
   1000022     1.85790042e+02   # ~neutralino(1)
   1000023     3.51522445e+02   # ~neutralino(2)
   1000024     3.51485226e+02   # ~chargino(1)
   1000025    -5.78814073e+02   # ~neutralino(3)
   1000035     5.94308916e+02   # ~neutralino(4)
   1000037     5.94507756e+02   # ~chargino(2)
   1000001     1.32508944e+03   # ~d_L
   1000002     1.32289103e+03   # ~u_L
   1000003     1.32508483e+03   # ~s_L
   1000004     1.32288642e+03   # ~c_L
   1000005     1.15058731e+03   # ~b_1
   1000006     9.19662155e+02   # ~t_1
   ...
   2000001     1.29958164e+03   # ~d_R
   2000002     1.30120236e+03   # ~u_R
   2000003     1.29957716e+03   # ~s_R
   2000004     1.30119740e+03   # ~c_R
   2000005     1.29082923e+03   # ~b_2
   2000006     1.17423387e+03   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -2.08390910e-02   # N_{1,2}
  1  3     9.18749841e-02   # N_{1,3}
  1  4    -3.80492368e-02   # N_{1,4}
  2  1     4.56836490e-02   # N_{2,1}
  2  2     9.64568134e-01   # N_{2,2}
  2  3    -2.16153875e-01   # N_{2,3}
  2  4     1.44217966e-01   # N_{2,4}
  3  1    -3.66859265e-02   # N_{3,1}
  3  2     5.32860149e-02   # N_{3,2}
  3  3     7.02741105e-01   # N_{3,3}
  3  4     7.08498189e-01   # N_{3,4}
  4  1    -8.30070591e-02   # N_{4,1}
  4  2     2.57555136e-01   # N_{4,2}
  4  3     6.71558955e-01   # N_{4,3}
  4  4    -6.89770796e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.50506771e-01   # U_{1,1}
  1  2    -3.10703844e-01   # U_{1,2}
  2  1     3.10703844e-01   # U_{2,1}
  2  2     9.50506771e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.78081713e-01   # V_{1,1}
  1  2    -2.08221428e-01   # V_{1,2}
  2  1     2.08221428e-01   # V_{2,1}
  2  2     9.78081713e-01   # V_{2,2}
...
Block yu Q= 1.01134642e+03  
  3  3     8.60888042e-01   # Yt(Q)MSSM DRbar
...
Block hmix Q= 1.01134642e+03 # Higgs mixing parameters
     1     5.71311035e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.01134642e+03  # MSSM DRbar SUSY breaking parameters
     1     1.88858154e+02      # M_1(Q)
     2     3.50124766e+02      # M_2(Q)
     3     9.97548569e+02      # M_3(Q)
    21     9.38689987e+05      # mH1^2(Q)
    22    -2.98329409e+05      # mH2^2(Q)
    31     9.90764890e+02      # meL(Q)
...
Block au Q= 1.01134642e+03  
  ...
  2  2    -1.01828233e+03      # Ac(Q)MSSM DRbar
  3  3    -7.84716397e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.01134642e+03  
  1  1    -2.68700619e+02      # Ae(Q)MSSM DRbar
  2  2    -2.68695808e+02      # Amu(Q)MSSM DRbar
  3  3    -2.67267235e+02      # Atau(Q)MSSM DRbar

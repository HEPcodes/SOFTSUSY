...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.08986777e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.61914215e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03908418e+01   # MW
        25     1.16883551e+02   # h0
        35     9.42583788e+02   # H0
        36     9.42686894e+02   # A0
        37     9.46262162e+02   # H+
   1000021     1.10074813e+03   # ~g
   1000022     1.88515050e+02   # ~neutralino(1)
   1000023     3.60117940e+02   # ~neutralino(2)
   1000024     3.60225266e+02   # ~chargino(1)
   1000025    -6.19932851e+02   # ~neutralino(3)
   1000035     6.30467871e+02   # ~neutralino(4)
   1000037     6.31565792e+02   # ~chargino(2)
   ...
   2000001     1.48466409e+03   # ~d_R
   2000002     1.48591562e+03   # ~u_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.28121941e-02   # N_{1,2}
  1  3     8.20645269e-02   # N_{1,3}
  1  4    -2.72467781e-02   # N_{1,4}
  2  1     3.11340098e-02   # N_{2,1}
  2  2     9.75152975e-01   # N_{2,2}
  2  3    -1.88400858e-01   # N_{2,3}
  2  4     1.12305234e-01   # N_{2,4}
  3  1    -3.78232921e-02   # N_{3,1}
  3  2     5.54567550e-02   # N_{3,2}
  3  3     7.02897273e-01   # N_{3,3}
  3  4     7.08116777e-01   # N_{3,4}
  4  1    -7.23961174e-02   # N_{4,1}
  4  2     2.14095940e-01   # N_{4,2}
  4  3     6.80959583e-01   # N_{4,3}
  4  4    -6.96574316e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.63200557e-01   # U_{1,1}
  1  2    -2.68783717e-01   # U_{1,2}
  2  1     2.68783717e-01   # U_{2,1}
  2  2     9.63200557e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.86988307e-01   # V_{1,1}
  1  2    -1.60792043e-01   # V_{1,2}
  2  1     1.60792043e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     1.76686850e-01   # F_{12}
  2  1    -1.76686850e-01   # F_{21}
...
Block hmix Q= 1.06740630e+03 # Higgs mixing parameters
     1     6.12070091e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.06740630e+03  # MSSM DRbar SUSY breaking parameters
     ...
     3     9.97158049e+02      # M_3(Q)
    21     5.37923140e+05      # mH1^2(Q)
    22    -3.57904210e+05      # mH2^2(Q)
...
Block au Q= 1.06740630e+03  
  1  1    -1.35325122e+03      # Au(Q)MSSM DRbar
  2  2    -1.35321767e+03      # Ac(Q)MSSM DRbar
  3  3    -9.19232593e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.06740630e+03  
  1  1    -5.92607888e+02      # Ae(Q)MSSM DRbar
  2  2    -5.92303290e+02      # Amu(Q)MSSM DRbar
  3  3    -4.97393938e+02      # Atau(Q)MSSM DRbar

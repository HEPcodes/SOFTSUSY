...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.16983953e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.16532611e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03920291e+01   # MW
        25     1.16233121e+02   # h0
        35     8.61532446e+02   # H0
        36     8.61649483e+02   # A0
        37     8.65547132e+02   # H+
   1000021     9.89071392e+02   # ~g
   1000022     1.66665589e+02   # ~neutralino(1)
   1000023     3.18507129e+02   # ~neutralino(2)
   1000024     3.18604679e+02   # ~chargino(1)
   1000025    -5.72304476e+02   # ~neutralino(3)
   1000035     5.82854688e+02   # ~neutralino(4)
   1000037     5.84121689e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.49998739e-02   # N_{1,2}
  1  3     8.85357784e-02   # N_{1,3}
  1  4    -2.82976633e-02   # N_{1,4}
  2  1     3.52650105e-02   # N_{2,1}
  2  2     9.73578056e-01   # N_{2,2}
  2  3    -1.95738180e-01   # N_{2,3}
  2  4     1.12199435e-01   # N_{2,4}
  3  1    -4.13829412e-02   # N_{3,1}
  3  2     6.10217621e-02   # N_{3,2}
  3  3     7.02059789e-01   # N_{3,3}
  3  4     7.08290794e-01   # N_{3,4}
  4  1    -7.68646163e-02   # N_{4,1}
  4  2     2.19538420e-01   # N_{4,2}
  4  3     6.78940375e-01   # N_{4,3}
  4  4    -6.96372515e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.60185897e-01   # U_{1,1}
  1  2    -2.79361851e-01   # U_{1,2}
  2  1     2.79361851e-01   # U_{2,1}
  2  2     9.60185897e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.87003891e-01   # V_{1,1}
  1  2    -1.60696360e-01   # V_{1,2}
  2  1     1.60696360e-01   # V_{2,1}
  2  2     9.87003891e-01   # V_{2,2}
...
Block gauge Q= 9.64465348e+02  # SM gauge couplings
     1     3.62031032e-01   # g'(Q)MSSM DRbar
     2     6.42228081e-01   # g(Q)MSSM DRbar
...
Block au Q= 9.64465348e+02  
  ...
  3  3    -8.39781766e+02      # At(Q)MSSM DRbar
Block ad Q= 9.64465348e+02  
  1  1    -1.45064485e+03      # Ad(Q)MSSM DRbar
  2  2    -1.45056414e+03      # As(Q)MSSM DRbar
  3  3    -1.19477353e+03      # Ab(Q)MSSM DRbar
Block ae Q= 9.64465348e+02  
  1  1    -5.72726497e+02      # Ae(Q)MSSM DRbar
  2  2    -5.72428090e+02      # Amu(Q)MSSM DRbar

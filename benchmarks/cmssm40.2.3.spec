...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.88704279e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.86822781e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03897995e+01   # MW
        25     1.17592527e+02   # h0
        35     7.31019980e+02   # H0
        36     7.31025956e+02   # A0
        37     7.35791158e+02   # H+
   1000021     1.27464309e+03   # ~g
   1000022     2.29843539e+02   # ~neutralino(1)
   1000023     4.38019454e+02   # ~neutralino(2)
   1000024     4.38150979e+02   # ~chargino(1)
   1000025    -7.50577827e+02   # ~neutralino(3)
   1000035     7.58905229e+02   # ~neutralino(4)
   1000037     7.59941041e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -8.97896626e-03   # N_{1,2}
  1  3     6.73111903e-02   # N_{1,3}
  1  4    -2.25265294e-02   # N_{1,4}
  2  1     2.15733180e-02   # N_{2,1}
  2  2     9.82863091e-01   # N_{2,2}
  2  3    -1.57135623e-01   # N_{2,3}
  2  4     9.39315285e-02   # N_{2,4}
  3  1    -3.11252526e-02   # N_{3,1}
  3  2     4.56185747e-02   # N_{3,2}
  3  3     7.04199700e-01   # N_{3,3}
  3  4     7.07850936e-01   # N_{3,4}
  4  1    -6.07015099e-02   # N_{4,1}
  4  2     1.78377319e-01   # N_{4,2}
  4  3     6.89115652e-01   # N_{4,3}
  4  4    -6.99726001e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.74611560e-01   # U_{1,1}
  1  2    -2.23902449e-01   # U_{1,2}
  2  1     2.23902449e-01   # U_{2,1}
  2  2     9.74611560e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.90932521e-01   # V_{1,1}
  1  2    -1.34360482e-01   # V_{1,2}
  2  1     1.34360482e-01   # V_{2,1}
...
Block gauge Q= 9.81985217e+02  # SM gauge couplings
     1     3.62276455e-01   # g'(Q)MSSM DRbar
     2     6.41583979e-01   # g(Q)MSSM DRbar
     3     1.05451478e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.81985217e+02  
  3  3     8.52295843e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.81985217e+02  
  3  3     4.95397907e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.81985217e+02  
  3  3     4.24552002e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.81985217e+02 # Higgs mixing parameters
     1     7.46393566e+02    # mu(Q)MSSM DRbar
     2     3.92051622e+01    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.43871758e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
     4     6.83734793e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.81985217e+02  # MSSM DRbar SUSY breaking parameters
     1     2.32721304e+02      # M_1(Q)
     2     4.30923109e+02      # M_2(Q)
     3     1.21817757e+03      # M_3(Q)
    21    -1.33708800e+04      # mH1^2(Q)
    22    -5.46547305e+05      # mH2^2(Q)
    ...
    46     9.08903113e+02      # mtR(Q)
    47     1.20847782e+03      # mdR(Q)
    48     1.20839999e+03      # msR(Q)
    49     1.09287197e+03      # mbR(Q)
Block au Q= 9.81985217e+02  
  1  1    -1.58110854e+03      # Au(Q)MSSM DRbar
  2  2    -1.58107042e+03      # Ac(Q)MSSM DRbar
  3  3    -1.09681787e+03      # At(Q)MSSM DRbar
Block ad Q= 9.81985217e+02  
  1  1    -1.83179024e+03      # Ad(Q)MSSM DRbar
  2  2    -1.83169318e+03      # As(Q)MSSM DRbar
  3  3    -1.53899677e+03      # Ab(Q)MSSM DRbar
Block ae Q= 9.81985217e+02  
  1  1    -6.43164702e+02      # Ae(Q)MSSM DRbar

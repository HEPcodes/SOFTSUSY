...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.61299574e-04
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -2.20610649e-04   # N_{1,2}
  1  3     1.81702586e-02   # N_{1,3}
  1  4    -4.65472727e-03   # N_{1,4}
  2  1     7.24426726e-03   # N_{2,1}
  2  2     9.02183592e-01   # N_{2,2}
  2  3    -3.11157745e-01   # N_{2,3}
  2  4     2.98652214e-01   # N_{2,4}
  3  1    -9.55265038e-03   # N_{3,1}
  3  2     9.79140593e-03   # N_{3,2}
  3  3     7.06913561e-01   # N_{3,3}
  3  4     7.07167655e-01   # N_{3,4}
  4  1    -1.44270897e-02   # N_{4,1}
  4  2     4.31241054e-01   # N_{4,2}
  4  3     6.34920402e-01   # N_{4,3}
  4  4    -6.40858094e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.22903127e-01   # U_{1,1}
  1  2    -5.68181700e-01   # U_{1,2}
  2  1     5.68181700e-01   # U_{2,1}
  2  2     8.22903127e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     8.33931982e-01   # V_{1,1}
  1  2    -5.51867239e-01   # V_{1,2}
  2  1     5.51867239e-01   # V_{2,1}
  2  2     8.33931982e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.38827270e-01   # F_{11}
  1  2     9.40848596e-01   # F_{12}
  2  1     9.40848596e-01   # F_{21}
  2  2    -3.38827270e-01   # F_{22}
...
Block staumix               # stau mixing matrix
  1  1     4.06063032e-01   # F_{11}
  1  2     9.13845071e-01   # F_{12}
  2  1     9.13845071e-01   # F_{21}
  2  2    -4.06063032e-01   # F_{22}
...
Block msoft Q= 2.50360530e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21    -3.42534488e+05      # mH1^2(Q)
    22    -6.24659025e+06      # mH2^2(Q)
...
Block au Q= 2.50360530e+03  
  1  1     2.04509816e-06      # Au(Q)MSSM DRbar
  2  2     2.04510290e-06      # Ac(Q)MSSM DRbar
  3  3     2.78615258e-06      # At(Q)MSSM DRbar
Block ad Q= 2.50360530e+03  
  1  1     1.42049779e-06      # Ad(Q)MSSM DRbar
  2  2     1.42049886e-06      # As(Q)MSSM DRbar
  3  3     1.59229887e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50360530e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.83832166e-08      # Amu(Q)MSSM DRbar
  3  3     1.82556964e-08      # Atau(Q)MSSM DRbar

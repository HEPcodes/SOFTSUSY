...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.12821354e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.39353866e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03913921e+01   # MW
        25     1.16569409e+02   # h0
        35     9.02126220e+02   # H0
        36     9.02235835e+02   # A0
        37     9.05965596e+02   # H+
   ...
   1000025    -5.96236958e+02   # ~neutralino(3)
   1000035     6.06779434e+02   # ~neutralino(4)
   1000037     6.07957041e+02   # ~chargino(2)
   1000001     1.43785735e+03   # ~d_L
   1000002     1.43578685e+03   # ~u_L
   1000003     1.43780733e+03   # ~s_L
   1000004     1.43573676e+03   # ~c_L
   1000005     1.12660414e+03   # ~b_1
   1000006     9.33638417e+02   # ~t_1
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.38329292e-02   # N_{1,2}
  1  3     8.51460403e-02   # N_{1,3}
  1  4    -2.77563784e-02   # N_{1,4}
  2  1     3.30694420e-02   # N_{2,1}
  2  2     9.74414737e-01   # N_{2,2}
  2  3    -1.91889642e-01   # N_{2,3}
  2  4     1.12252831e-01   # N_{2,4}
  3  1    -3.95176752e-02   # N_{3,1}
  3  2     5.81001486e-02   # N_{3,2}
  3  3     7.02508333e-01   # N_{3,3}
  3  4     7.08198255e-01   # N_{3,4}
  4  1    -7.45411296e-02   # N_{4,1}
  4  2     2.16677050e-01   # N_{4,2}
  4  3     6.80007764e-01   # N_{4,3}
  4  4    -6.96479804e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.61785096e-01   # U_{1,1}
  1  2    -2.73805458e-01   # U_{1,2}
  2  1     2.73805458e-01   # U_{2,1}
  2  2     9.61785096e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.86996949e-01   # V_{1,1}
  1  2    -1.60738988e-01   # V_{1,2}
  2  1     1.60738988e-01   # V_{2,1}
...
Block gauge Q= 1.01597243e+03  # SM gauge couplings
     ...
     2     6.41963772e-01   # g(Q)MSSM DRbar
...
Block au Q= 1.01597243e+03  
  ...
  3  3    -8.79626042e+02      # At(Q)MSSM DRbar
Block ad Q= 1.01597243e+03  
  1  1    -1.50810297e+03      # Ad(Q)MSSM DRbar
...
Block ae Q= 1.01597243e+03  
  ...
  3  3    -4.88523455e+02      # Atau(Q)MSSM DRbar

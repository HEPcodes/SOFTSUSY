...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.71624643e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.24481975e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03886878e+01   # MW
        25     1.18305576e+02   # h0
        35     7.58115774e+02   # H0
        36     7.58120748e+02   # A0
        37     7.62665584e+02   # H+
   1000021     1.46727872e+03   # ~g
   1000022     2.72324217e+02   # ~neutralino(1)
   1000023     5.18125070e+02   # ~neutralino(2)
   1000024     5.18266350e+02   # ~chargino(1)
   1000025    -8.60813293e+02   # ~neutralino(3)
   1000035     8.68428625e+02   # ~neutralino(4)
   1000037     8.69328720e+02   # ~chargino(2)
   1000001     1.38375682e+03   # ~d_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -6.88743760e-03   # N_{1,2}
  1  3     5.88848041e-02   # N_{1,3}
  1  4    -2.03201515e-02   # N_{1,4}
  2  1     1.69708830e-02   # N_{2,1}
  2  2     9.85825166e-01   # N_{2,2}
  2  3    -1.42129623e-01   # N_{2,3}
  2  4     8.75208571e-02   # N_{2,4}
  3  1    -2.69116374e-02   # N_{3,1}
  3  2     3.92671486e-02   # N_{3,2}
  3  3     7.04925384e-01   # N_{3,3}
  3  4     7.07682173e-01   # N_{3,4}
  4  1    -5.39955406e-02   # N_{4,1}
  4  2     1.62970535e-01   # N_{4,2}
  4  3     6.92395807e-01   # N_{4,3}
  4  4    -7.00794644e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.79329384e-01   # U_{1,1}
  1  2    -2.02271991e-01   # U_{1,2}
  2  1     2.02271991e-01   # U_{2,1}
  2  2     9.79329384e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.92159334e-01   # V_{1,1}
  1  2    -1.24979424e-01   # V_{1,2}
  2  1     1.24979424e-01   # V_{2,1}
  2  2     9.92159334e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.17867891e-01   # F_{11}
  1  2     9.08507802e-01   # F_{12}
  2  1     9.08507802e-01   # F_{21}
  2  2    -4.17867891e-01   # F_{22}
...
Block yu Q= 1.08706473e+03  
  3  3     8.48084658e-01   # Yt(Q)MSSM DRbar

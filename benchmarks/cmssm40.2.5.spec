...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.79840916e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.97795668e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03886366e+01   # MW
        25     1.18443308e+02   # h0
        35     8.65273058e+02   # H0
        36     8.65265229e+02   # A0
        37     8.69291003e+02   # H+
   1000021     1.49024590e+03   # ~g
   1000022     2.73950153e+02   # ~neutralino(1)
   1000023     5.21376206e+02   # ~neutralino(2)
   1000024     5.21515840e+02   # ~chargino(1)
   1000025    -8.51062285e+02   # ~neutralino(3)
   1000035     8.59250068e+02   # ~neutralino(4)
   1000037     8.60102927e+02   # ~chargino(2)
   1000001     1.52213614e+03   # ~d_L
   1000002     1.52021001e+03   # ~u_L
   1000003     1.52209258e+03   # ~s_L
   1000004     1.52016639e+03   # ~c_L
   1000005     1.27098703e+03   # ~b_1
   1000006     1.08717259e+03   # ~t_1
   1000011     8.65185250e+02   # ~e_L
   1000012     8.61214049e+02   # ~nue_L
   1000013     8.64978781e+02   # ~mu_L
   1000014     8.61006716e+02   # ~numu_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -7.00710769e-03   # N_{1,2}
  1  3     5.97993156e-02   # N_{1,3}
  1  4    -2.09085030e-02   # N_{1,4}
  2  1     1.75984350e-02   # N_{2,1}
  2  2     9.84844451e-01   # N_{2,2}
  2  3    -1.46317434e-01   # N_{2,3}
  2  4     9.14489559e-02   # N_{2,4}
  3  1    -2.71348549e-02   # N_{3,1}
  3  2     3.94999021e-02   # N_{3,2}
  3  3     7.04907217e-01   # N_{3,3}
  3  4     7.07678792e-01   # N_{3,4}
  4  1    -5.49201050e-02   # N_{4,1}
  4  2     1.68736677e-01   # N_{4,2}
  4  3     6.91462990e-01   # N_{4,3}
  4  4    -7.00278980e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.78026115e-01   # U_{1,1}
  1  2    -2.08482416e-01   # U_{1,2}
  2  1     2.08482416e-01   # U_{2,1}
  2  2     9.78026115e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91407083e-01   # V_{1,1}
  1  2    -1.30812826e-01   # V_{1,2}
  2  1     1.30812826e-01   # V_{2,1}
...
Block gauge Q= 1.16443025e+03  # SM gauge couplings
     1     3.62625130e-01   # g'(Q)MSSM DRbar
     2     6.40749660e-01   # g(Q)MSSM DRbar
     3     1.04601378e+00   # g3(Q)MSSM DRbar
Block yu Q= 1.16443025e+03  
  3  3     8.46875216e-01   # Yt(Q)MSSM DRbar
Block yd Q= 1.16443025e+03  
  3  3     4.95567015e-01   # Yb(Q)MSSM DRbar
Block ye Q= 1.16443025e+03  
  3  3     4.23709286e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 1.16443025e+03 # Higgs mixing parameters
     1     8.46596017e+02    # mu(Q)MSSM DRbar
     2     3.91663556e+01    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.43672839e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
     4     9.57107135e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 1.16443025e+03  # MSSM DRbar SUSY breaking parameters
     1     2.77018428e+02      # M_1(Q)
     2     5.10792770e+02      # M_2(Q)
     3     1.42163473e+03      # M_3(Q)
    21     4.46851154e+04      # mH1^2(Q)
    22    -6.99015975e+05      # mH2^2(Q)
    31     8.60786196e+02      # meL(Q)
    ...
    48     1.43128792e+03      # msR(Q)
    49     1.29697418e+03      # mbR(Q)
Block au Q= 1.16443025e+03  
  1  1    -1.78111537e+03      # Au(Q)MSSM DRbar
  2  2    -1.78107371e+03      # Ac(Q)MSSM DRbar
  3  3    -1.25136021e+03      # At(Q)MSSM DRbar
Block ad Q= 1.16443025e+03  
  1  1    -2.05354987e+03      # Ad(Q)MSSM DRbar
  2  2    -2.05344380e+03      # As(Q)MSSM DRbar
  3  3    -1.73151976e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.16443025e+03  
  1  1    -6.82580307e+02      # Ae(Q)MSSM DRbar
  2  2    -6.82247894e+02      # Amu(Q)MSSM DRbar

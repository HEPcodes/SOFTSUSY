...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.02197562e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.41072046e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03910849e+01   # MW
        25     1.16557283e+02   # h0
        35     6.30939486e+02   # H0
        36     6.30911473e+02   # A0
        37     6.36450165e+02   # H+
   1000021     1.06318928e+03   # ~g
   1000022     1.86425625e+02   # ~neutralino(1)
   1000023     3.55657080e+02   # ~neutralino(2)
   1000024     3.55774156e+02   # ~chargino(1)
   1000025    -6.44992767e+02   # ~neutralino(3)
   1000035     6.53676898e+02   # ~neutralino(4)
   1000037     6.54956724e+02   # ~chargino(2)
   1000001     1.09460464e+03   # ~d_L
   1000002     1.09186764e+03   # ~u_L
   1000003     1.09456965e+03   # ~s_L
   1000004     1.09183254e+03   # ~c_L
   1000005     8.95282840e+02   # ~b_1
   1000006     7.50184655e+02   # ~t_1
   1000011     6.27371898e+02   # ~e_L
   1000012     6.21995122e+02   # ~nue_L
   1000013     6.27202288e+02   # ~mu_L
   1000014     6.21824154e+02   # ~numu_L
   1000015     4.23392990e+02   # ~stau_1
   ...
   2000005     9.69667193e+02   # ~b_2
   2000006     9.60080451e+02   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.21175619e-02   # N_{1,2}
  1  3     7.79436562e-02   # N_{1,3}
  1  4    -2.48002161e-02   # N_{1,4}
  2  1     2.78881838e-02   # N_{2,1}
  2  2     9.79609997e-01   # N_{2,2}
  2  3    -1.73022297e-01   # N_{2,3}
  2  4     9.82333336e-02   # N_{2,4}
  3  1    -3.67057599e-02   # N_{3,1}
  3  2     5.42119517e-02   # N_{3,2}
  3  3     7.03052257e-01   # N_{3,3}
  3  4     7.08118123e-01   # N_{3,4}
  4  1    -6.86442711e-02   # N_{4,1}
  4  2     1.93076366e-01   # N_{4,2}
  4  3     6.85350710e-01   # N_{4,3}
  4  4    -6.98787439e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.69100495e-01   # U_{1,1}
  1  2    -2.46666235e-01   # U_{1,2}
  2  1     2.46666235e-01   # U_{2,1}
  2  2     9.69100495e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.90069020e-01   # V_{1,1}
  1  2    -1.40582129e-01   # V_{1,2}
  2  1     1.40582129e-01   # V_{2,1}
  2  2     9.90069020e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.51814688e-01   # F_{11}
  1  2     8.92111813e-01   # F_{12}
  2  1     8.92111813e-01   # F_{21}
  2  2    -4.51814688e-01   # F_{22}
...
Block staumix               # stau mixing matrix
  1  1     3.13495694e-01   # F_{11}
  1  2     9.49589622e-01   # F_{12}
  2  1     9.49589622e-01   # F_{21}
  2  2    -3.13495694e-01   # F_{22}
Block gauge Q= 8.23117243e+02  # SM gauge couplings
     1     3.61863494e-01   # g'(Q)MSSM DRbar
     2     6.42453061e-01   # g(Q)MSSM DRbar
     3     1.06387661e+00   # g3(Q)MSSM DRbar
Block yu Q= 8.23117243e+02  
  3  3     8.58488303e-01   # Yt(Q)MSSM DRbar
Block yd Q= 8.23117243e+02  
  3  3     4.97304720e-01   # Yb(Q)MSSM DRbar
Block ye Q= 8.23117243e+02  
  3  3     4.23565555e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 8.23117243e+02 # Higgs mixing parameters
     1     6.40358663e+02    # mu(Q)MSSM DRbar
     2     3.92490005e+01    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.44080520e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
     4     5.09552387e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 8.23117243e+02  # MSSM DRbar SUSY breaking parameters
     1     1.88921429e+02      # M_1(Q)
     2     3.51467000e+02      # M_2(Q)
     3     1.01087160e+03      # M_3(Q)
    21    -3.01384521e+03      # mH1^2(Q)
    22    -4.04645267e+05      # mH2^2(Q)
    ...
    43     8.85958082e+02      # mqL3(Q)
    44     1.03452788e+03      # muR(Q)
    45     1.03452332e+03      # mcR(Q)
    46     7.58311528e+02      # mtR(Q)
    47     1.03117994e+03      # mdR(Q)
    48     1.03110893e+03      # msR(Q)
    49     9.26480712e+02      # mbR(Q)
Block au Q= 8.23117243e+02  
  1  1    -1.37478656e+03      # Au(Q)MSSM DRbar
  2  2    -1.37475216e+03      # Ac(Q)MSSM DRbar
  3  3    -9.37347462e+02      # At(Q)MSSM DRbar
Block ad Q= 8.23117243e+02  
  1  1    -1.60153426e+03      # Ad(Q)MSSM DRbar
  2  2    -1.60144665e+03      # As(Q)MSSM DRbar
  3  3    -1.33779444e+03      # Ab(Q)MSSM DRbar
Block ae Q= 8.23117243e+02  
  1  1    -6.02572761e+02      # Ae(Q)MSSM DRbar
  2  2    -6.02265537e+02      # Amu(Q)MSSM DRbar
  3  3    -5.01609860e+02      # Atau(Q)MSSM DRbar

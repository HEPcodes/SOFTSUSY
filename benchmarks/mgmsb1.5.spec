...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.28733173e-05
...
# PDG code     mass             particle
   ...
   1000035     4.99916347e+02   # ~neutralino(4)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  4    -1.03548581e-01   # N_{1,4}
  2  1    -1.83718063e-01   # N_{2,1}
  2  2    -5.63235985e-01   # N_{2,2}
  2  3     5.90960743e-01   # N_{2,3}
  2  4    -5.47520135e-01   # N_{2,4}
  3  1    -4.48702270e-02   # N_{3,1}
  3  2     6.02092042e-02   # N_{3,2}
  3  3     7.00739147e-01   # N_{3,3}
  3  4     7.09454835e-01   # N_{3,4}
  4  1    -7.56057132e-02   # N_{4,1}
  4  2     8.23158857e-01   # N_{4,2}
  4  3     3.61275577e-01   # N_{4,3}
  4  4    -4.31477960e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -5.08300252e-01   # U_{1,1}
  1  2     8.61179919e-01   # U_{1,2}
  2  1    -8.61179919e-01   # U_{2,1}
  2  2    -5.08300252e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -6.07680454e-01   # V_{1,1}
  1  2     7.94181633e-01   # V_{1,2}
  2  1    -7.94181633e-01   # V_{2,1}
  2  2    -6.07680454e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.68302534e-01   # F_{11}
  1  2     8.83568184e-01   # F_{12}
  2  1     8.83568184e-01   # F_{21}
  2  2    -4.68302534e-01   # F_{22}
...
Block hmix Q= 1.09054749e+03 # Higgs mixing parameters
     1     4.04626368e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.09054749e+03  # MSSM DRbar SUSY breaking parameters
    ...
    31     3.47483339e+02      # meL(Q)
    32     3.47481858e+02      # mmuL(Q)
    33     3.47025975e+02      # mtauL(Q)
...
Block au Q= 1.09054749e+03  
  ...
  3  3    -3.40565914e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.09054749e+03  
  1  1    -3.76468029e+01      # Ae(Q)MSSM DRbar
  2  2    -3.76465287e+01      # Amu(Q)MSSM DRbar
  3  3    -3.75621025e+01      # Atau(Q)MSSM DRbar

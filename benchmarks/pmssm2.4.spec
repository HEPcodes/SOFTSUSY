...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.49706746e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04068776e+01   # MW
   ...
   1000035     2.57986414e+03   # ~neutralino(4)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -2.66734353e-04   # N_{1,2}
  1  3     1.75271659e-02   # N_{1,3}
  1  4    -2.64060108e-03   # N_{1,4}
  2  1     7.65717658e-03   # N_{2,1}
  2  2     8.57337513e-01   # N_{2,2}
  2  3    -3.69828331e-01   # N_{2,3}
  2  4     3.57967543e-01   # N_{2,4}
  3  1    -1.05216976e-02   # N_{3,1}
  3  2     9.76352533e-03   # N_{3,2}
  3  3     7.06902140e-01   # N_{3,3}
  3  4     7.07165703e-01   # N_{3,4}
  4  1    -1.20377320e-02   # N_{4,1}
  4  2     5.14662017e-01   # N_{4,2}
  4  3     6.02668373e-01   # N_{4,3}
  4  4    -6.09728574e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.80918128e-01   # U_{1,1}
  1  2    -6.24633394e-01   # U_{1,2}
  2  1     6.24633394e-01   # U_{2,1}
  2  2     7.80918128e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     7.93036466e-01   # V_{1,1}
  1  2    -6.09174166e-01   # V_{1,2}
  2  1     6.09174166e-01   # V_{2,1}
  2  2     7.93036466e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.24935970e-01   # F_{11}
  1  2     9.05223409e-01   # F_{12}
  2  1     9.05223409e-01   # F_{21}
  2  2    -4.24935970e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.95968907e-01   # F_{11}
  1  2     9.18263919e-01   # F_{12}
  2  1     9.18263919e-01   # F_{21}
  2  2    -3.95968907e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     4.06029351e-01   # F_{11}
  1  2     9.13860036e-01   # F_{12}
  2  1     9.13860036e-01   # F_{21}
  2  2    -4.06029351e-01   # F_{22}
Block gauge Q= 2.50366728e+03  # SM gauge couplings
     1     3.64725139e-01   # g'(Q)MSSM DRbar
     2     6.36082546e-01   # g(Q)MSSM DRbar
     3     1.01384350e+00   # g3(Q)MSSM DRbar
Block yu Q= 2.50366728e+03  
  3  3     8.33687244e-01   # Yt(Q)MSSM DRbar
Block yd Q= 2.50366728e+03  
  3  3     1.25601165e-01   # Yb(Q)MSSM DRbar
Block ye Q= 2.50366728e+03  
  3  3     9.97689807e-02   # Ytau(Q)MSSM DRbar
Block hmix Q= 2.50366728e+03 # Higgs mixing parameters
     1     2.53486707e+03    # mu(Q)MSSM DRbar
     2     9.54823731e+00    # tan beta(Q)MSSM DRbar Feynman gauge
     3     2.43712932e+02    # higgs vev(Q)MSSM DRbar Feynman gauge
...
Block au Q= 2.50366728e+03  
  ...
  2  2     6.10926250e-06      # Ac(Q)MSSM DRbar
  3  3     1.02276177e-05      # At(Q)MSSM DRbar
Block ad Q= 2.50366728e+03  
  1  1     2.09601453e-06      # Ad(Q)MSSM DRbar
  2  2     2.09608921e-06      # As(Q)MSSM DRbar
  3  3     3.43616380e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50366728e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.21599378e-07      # Amu(Q)MSSM DRbar
  3  3     1.21903702e-07      # Atau(Q)MSSM DRbar

...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.27117776e-05
...
# PDG code     mass             particle
   ...
   1000024     3.85994769e+02   # ~chargino(1)
   1000025    -7.85245777e+02   # ~neutralino(3)
   ...
   1000006     9.72562098e+02   # ~t_1
   1000011     6.66690667e+02   # ~e_L
   1000012     6.61648438e+02   # ~nue_L
   1000013     6.66676566e+02   # ~mu_L
   1000014     6.61634238e+02   # ~numu_L
   1000015     4.37465619e+02   # ~stau_1
   1000016     6.57004410e+02   # ~nu_tau_L
   2000001     1.24421148e+03   # ~d_R
   2000002     1.26945732e+03   # ~u_R
   2000003     1.24420333e+03   # ~s_R
   2000004     1.26945330e+03   # ~c_R
   2000005     1.25298347e+03   # ~b_2
   2000006     1.26541683e+03   # ~t_2
   2000011     4.52937050e+02   # ~e_R
   2000013     4.52895244e+02   # ~mu_R
   2000015     6.63425094e+02   # ~stau_2
...
Block Umix                  # chargino U mixing matrix 
  ...
  1  2    -1.89927026e-01   # U_{1,2}
  2  1     1.89927026e-01   # U_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.33843686e-01   # F_{11}
  1  2     9.00988156e-01   # F_{12}
  2  1     9.00988156e-01   # F_{21}
  2  2    -4.33843686e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     8.40904863e-02   # F_{11}
  1  2     9.96458123e-01   # F_{12}
  2  1     9.96458123e-01   # F_{21}
  2  2    -8.40904863e-02   # F_{22}
...
Block hmix Q= 1.07751789e+03 # Higgs mixing parameters
     1     7.78954920e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.07751789e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21     3.75820915e+05      # mH1^2(Q)
    22    -5.86942256e+05      # mH2^2(Q)
    31     6.63046248e+02      # meL(Q)
    32     6.63032074e+02      # mmuL(Q)
    33     6.58708787e+02      # mtauL(Q)
    34     4.47997552e+02      # meR(Q)
    35     4.47955312e+02      # mmuR(Q)
    36     4.34919996e+02      # mtauR(Q)
...
Block ae Q= 1.07751789e+03  
  1  1    -2.13502866e+02      # Ae(Q)MSSM DRbar
  2  2    -2.13495541e+02      # Amu(Q)MSSM DRbar
  3  3    -2.11267672e+02      # Atau(Q)MSSM DRbar

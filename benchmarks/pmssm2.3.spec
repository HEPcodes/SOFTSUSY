...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.48936608e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04069593e+01   # MW
        25     1.17079409e+02   # h0
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.03177635e-04   # N_{1,2}
  1  3     1.75022101e-02   # N_{1,3}
  1  4    -2.53670835e-03   # N_{1,4}
  2  1     7.56849320e-03   # N_{2,1}
  2  2     8.60483215e-01   # N_{2,2}
  2  3    -3.66118882e-01   # N_{2,3}
  2  4     3.54215074e-01   # N_{2,4}
  3  1    -1.05771606e-02   # N_{3,1}
  3  2     9.76353709e-03   # N_{3,2}
  3  3     7.06901507e-01   # N_{3,3}
  3  4     7.07165508e-01   # N_{3,4}
  4  1    -1.19873161e-02   # N_{4,1}
  4  2     5.09385137e-01   # N_{4,2}
  4  3     6.04930488e-01   # N_{4,3}
  4  4    -6.11916817e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.80764911e-01   # U_{1,1}
  1  2    -6.24824899e-01   # U_{1,2}
  2  1     6.24824899e-01   # U_{2,1}
  2  2     7.80764911e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     7.92887154e-01   # V_{1,1}
  1  2    -6.09368493e-01   # V_{1,2}
  2  1     6.09368493e-01   # V_{2,1}
  2  2     7.92887154e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.24898877e-01   # F_{11}
  1  2     9.05240821e-01   # F_{12}
  2  1     9.05240821e-01   # F_{21}
  2  2    -4.24898877e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.95964098e-01   # F_{11}
  1  2     9.18265992e-01   # F_{12}
  2  1     9.18265992e-01   # F_{21}
  2  2    -3.95964098e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     4.06006254e-01   # F_{11}
  1  2     9.13870298e-01   # F_{12}
  2  1     9.13870298e-01   # F_{21}
  2  2    -4.06006254e-01   # F_{22}
Block gauge Q= 2.50366728e+03  # SM gauge couplings
     1     3.64737684e-01   # g'(Q)MSSM DRbar
     2     6.36088464e-01   # g(Q)MSSM DRbar
...
Block au Q= 2.50366728e+03  
  1  1     6.10887198e-06      # Au(Q)MSSM DRbar
  2  2     6.10894435e-06      # Ac(Q)MSSM DRbar
  3  3     1.02277126e-05      # At(Q)MSSM DRbar
Block ad Q= 2.50366728e+03  
  1  1     2.09547998e-06      # Ad(Q)MSSM DRbar
  2  2     2.09555487e-06      # As(Q)MSSM DRbar
  3  3     3.43578459e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50366728e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.21598412e-07      # Amu(Q)MSSM DRbar
  3  3     1.21903701e-07      # Atau(Q)MSSM DRbar

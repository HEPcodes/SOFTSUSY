...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.27305017e-04
...
# PDG code     mass             particle
   ...
   1000024     2.94311951e+02   # ~chargino(1)
   ...
   1000011     3.48546006e+02   # ~e_L
   1000012     3.39099182e+02   # ~nue_L
   1000013     3.48544510e+02   # ~mu_L
   1000014     3.39097647e+02   # ~numu_L
   1000015     1.68048346e+02   # ~stau_1
   1000016     3.38419289e+02   # ~nu_tau_L
   ...
   2000015     3.49570265e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -7.48152917e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.86481493e-01   # N_{1,1}
  1  2    -3.68314342e-02   # N_{1,2}
  1  3     1.44857952e-01   # N_{1,3}
  1  4    -6.71854370e-02   # N_{1,4}
  2  1     1.08686237e-01   # N_{2,1}
  2  2     8.68797016e-01   # N_{2,2}
  2  3    -3.82233936e-01   # N_{2,3}
  2  4     2.95425566e-01   # N_{2,4}
  3  1    -5.15861257e-02   # N_{3,1}
  3  2     7.26339561e-02   # N_{3,2}
  3  3     6.98903978e-01   # N_{3,3}
  3  4     7.09645270e-01   # N_{3,4}
  4  1    -1.11267413e-01   # N_{4,1}
  4  2     4.88425530e-01   # N_{4,2}
  4  3     5.86895751e-01   # N_{4,3}
  4  4    -6.36092322e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.31216577e-01   # U_{1,1}
  1  2    -5.55948740e-01   # U_{1,2}
  2  1     5.55948740e-01   # U_{2,1}
  2  2     8.31216577e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02631437e-01   # V_{1,1}
  1  2    -4.30414323e-01   # V_{1,2}
  2  1     4.30414323e-01   # V_{2,1}
  2  2     9.02631437e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.57024799e-01   # F_{11}
  1  2     9.66404808e-01   # F_{12}
  2  1     9.66404808e-01   # F_{21}
  2  2    -2.57024799e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     4.42003712e-01   # F_{11}
  1  2     8.97013221e-01   # F_{12}
  2  1     8.97013221e-01   # F_{21}
  2  2    -4.42003712e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.11285629e-01   # F_{11}
  1  2     9.93788463e-01   # F_{12}
  2  1     9.93788463e-01   # F_{21}
  2  2    -1.11285629e-01   # F_{22}
Block gauge Q= 1.02184998e+03  # SM gauge couplings
     1     3.63124131e-01   # g'(Q)MSSM DRbar
     2     6.44443733e-01   # g(Q)MSSM DRbar
...
Block ae Q= 1.02184998e+03  
  1  1    -2.68534940e+01      # Ae(Q)MSSM DRbar
  2  2    -2.68532954e+01      # Amu(Q)MSSM DRbar

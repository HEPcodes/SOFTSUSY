...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.66887493e-05
...
# PDG code     mass             particle
   ...
   1000016     3.79466238e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.68058035e-02   # N_{1,2}
  1  3     1.70073586e-01   # N_{1,3}
  1  4    -1.08042975e-01   # N_{1,4}
  2  1    -1.90864348e-01   # N_{2,1}
  2  2    -4.82722350e-01   # N_{2,2}
  2  3     6.20688755e-01   # N_{2,3}
  2  4    -5.87618417e-01   # N_{2,4}
  3  1    -4.15506350e-02   # N_{3,1}
  3  2     5.52856883e-02   # N_{3,2}
  3  3     7.01620739e-01   # N_{3,3}
  3  4     7.09186418e-01   # N_{3,4}
  4  1    -6.16224122e-02   # N_{4,1}
  4  2     8.73251372e-01   # N_{4,2}
  4  3     3.05857457e-01   # N_{4,3}
  4  4    -3.74280558e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -4.29949347e-01   # U_{1,1}
  1  2     9.02853011e-01   # U_{1,2}
  2  1    -9.02853011e-01   # U_{2,1}
  2  2    -4.29949347e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -5.26611507e-01   # V_{1,1}
  1  2     8.50106064e-01   # V_{1,2}
  2  1    -8.50106064e-01   # V_{2,1}
  2  2    -5.26611507e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.15408088e-01   # F_{11}
  1  2     9.09635158e-01   # F_{12}
  2  1     9.09635158e-01   # F_{21}
  2  2    -4.15408088e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     9.82154828e-02   # F_{11}
  1  2     9.95165172e-01   # F_{12}
  2  1     9.95165172e-01   # F_{21}
  2  2    -9.82154828e-02   # F_{22}
Block gauge Q= 1.18797304e+03  # SM gauge couplings
     1     3.63457025e-01   # g'(Q)MSSM DRbar
     2     6.42920982e-01   # g(Q)MSSM DRbar
...
Block hmix Q= 1.18797304e+03 # Higgs mixing parameters
     1     4.28302463e+02    # mu(Q)MSSM DRbar
...
Block ae Q= 1.18797304e+03  
  1  1    -4.02928047e+01      # Ae(Q)MSSM DRbar
  2  2    -4.02925220e+01      # Amu(Q)MSSM DRbar
  3  3    -4.02054066e+01      # Atau(Q)MSSM DRbar

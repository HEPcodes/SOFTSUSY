...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.61728237e-05
...
# PDG code     mass             particle
   ...
   1000013     2.31278631e+02   # ~mu_L
   1000014     2.16883687e+02   # ~numu_L
   ...
   2000015     2.33641164e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -8.19974481e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.55294191e-01   # N_{1,1}
  1  2    -8.09318488e-02   # N_{1,2}
  1  3     2.47855174e-01   # N_{1,3}
  1  4    -1.39394611e-01   # N_{1,4}
  2  1    -2.62559216e-01   # N_{2,1}
  2  2    -6.53314767e-01   # N_{2,2}
  2  3     5.37964152e-01   # N_{2,3}
  2  4    -4.63505172e-01   # N_{2,4}
  3  1    -6.79272076e-02   # N_{3,1}
  3  2     9.21924623e-02   # N_{3,2}
  3  3     6.92496936e-01   # N_{3,3}
  3  4     7.12274132e-01   # N_{3,4}
  4  1    -1.17735134e-01   # N_{4,1}
  4  2     7.47081255e-01   # N_{4,2}
  4  3     4.11837806e-01   # N_{4,3}
  4  4    -5.08328299e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -5.81564296e-01   # U_{1,1}
  1  2     8.13500442e-01   # U_{1,2}
  2  1    -8.13500442e-01   # U_{2,1}
  2  2    -5.81564296e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -7.19857993e-01   # V_{1,1}
  1  2     6.94121365e-01   # V_{1,2}
  2  1    -6.94121365e-01   # V_{2,1}
  2  2    -7.19857993e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     5.99487713e-01   # F_{11}
  1  2     8.00383959e-01   # F_{12}
  2  1     8.00383959e-01   # F_{21}
  2  2    -5.99487713e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.73854953e-01   # F_{11}
  1  2     9.84771271e-01   # F_{12}
  2  1     9.84771271e-01   # F_{21}
  2  2    -1.73854953e-01   # F_{22}
...
Block msoft Q= 7.29473536e+02  # MSSM DRbar SUSY breaking parameters
    ...
    21     4.26438154e+04      # mH1^2(Q)
    22    -6.75544396e+04      # mH2^2(Q)
...
Block ae Q= 7.29473536e+02  
  1  1    -2.38599127e+01      # Ae(Q)MSSM DRbar
  2  2    -2.38597385e+01      # Amu(Q)MSSM DRbar

...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.54799848e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04067180e+01   # MW
   ...
   1000037     2.57998668e+03   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -2.29831423e-04   # N_{1,2}
  1  3     1.75790118e-02   # N_{1,3}
  1  4    -2.84936006e-03   # N_{1,4}
  2  1     7.84183957e-03   # N_{2,1}
  2  2     8.52121044e-01   # N_{2,2}
  2  3    -3.75866592e-01   # N_{2,3}
  2  4     3.64077652e-01   # N_{2,4}
  3  1    -1.04111002e-02   # N_{3,1}
  3  2     9.76347411e-03   # N_{3,2}
  3  3     7.06903419e-01   # N_{3,3}
  3  4     7.07166063e-01   # N_{3,4}
  4  1    -1.21370457e-02   # N_{4,1}
  4  2     5.23253618e-01   # N_{4,2}
  4  3     5.98918057e-01   # N_{4,3}
  4  4    -6.06098593e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.81254112e-01   # U_{1,1}
  1  2    -6.24213115e-01   # U_{1,2}
  2  1     6.24213115e-01   # U_{2,1}
  2  2     7.81254112e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     7.93363865e-01   # V_{1,1}
  1  2    -6.08747713e-01   # V_{1,2}
  2  1     6.08747713e-01   # V_{2,1}
  2  2     7.93363865e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.25015236e-01   # F_{11}
  1  2     9.05186196e-01   # F_{12}
  2  1     9.05186196e-01   # F_{21}
  2  2    -4.25015236e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.95982551e-01   # F_{11}
  1  2     9.18258035e-01   # F_{12}
  2  1     9.18258035e-01   # F_{21}
  2  2    -3.95982551e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     4.06087517e-01   # F_{11}
  1  2     9.13834191e-01   # F_{12}
  2  1     9.13834191e-01   # F_{21}
  2  2    -4.06087517e-01   # F_{22}
Block gauge Q= 2.50366730e+03  # SM gauge couplings
     1     3.64699529e-01   # g'(Q)MSSM DRbar
     2     6.36068979e-01   # g(Q)MSSM DRbar
     3     1.01384349e+00   # g3(Q)MSSM DRbar
Block yu Q= 2.50366730e+03  
  3  3     8.33687067e-01   # Yt(Q)MSSM DRbar
Block yd Q= 2.50366730e+03  
  3  3     1.25606710e-01   # Yb(Q)MSSM DRbar
Block ye Q= 2.50366730e+03  
  3  3     9.97647987e-02   # Ytau(Q)MSSM DRbar
...
Block au Q= 2.50366730e+03  
  1  1     6.10981626e-06      # Au(Q)MSSM DRbar
  2  2     6.10988862e-06      # Ac(Q)MSSM DRbar
  3  3     1.02274299e-05      # At(Q)MSSM DRbar
Block ad Q= 2.50366730e+03  
  1  1     2.09705803e-06      # Ad(Q)MSSM DRbar
  2  2     2.09713278e-06      # As(Q)MSSM DRbar
  3  3     3.43690352e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50366730e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.21601525e-07      # Amu(Q)MSSM DRbar
  3  3     1.21903873e-07      # Atau(Q)MSSM DRbar
